...
public interface Combiner<I, M> {
    ...
    static Combiner<JsonObject, Collection<BBag>> outChildren() {
        ...
        // return Fx.po?lThread(Pool.COMBINER, CombinerOutChildren::new, CombinerOutChildren.class.getName());
    }
