...
final class AtConfiguration {
    ...
    static Init getInit(final Class<?> initClass) {
        if (Objects.isNull(initClass)) {
            ...
            Fx.outWeb(!Ut.isImplement(initClass, Init.class), _500InitSpecificationException.class,
    ...
    static Prerequisite getPrerequisite() {
        ...
        if (Objects.isNull(prerequisite)) {
            ...
            Fx.outWeb(!Ut.isImplement(prerequisite, Prerequisite.class), _500PrerequisiteSpecException.class,
