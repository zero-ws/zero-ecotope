...
public abstract class BaseZeroException extends RuntimeException {
    ...
    public BaseZeroException() {
        super();
    }

    public BaseZeroException(final String message) {
        super(message);
    }

    public BaseZeroException(final String message, final Throwable cause) {
        super(message, cause);
    }

    public BaseZeroException(final Throwable cause) {
        super(cause);
    }
     ...
     * @return 当前异常信息
     */
    public BaseZeroException io(final HorizonIo io) {
        return this;
    }
}
