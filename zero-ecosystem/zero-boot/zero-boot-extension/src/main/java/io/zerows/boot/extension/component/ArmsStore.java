...
public class ArmsStore {
    ...
    private static final ArmsSix HEX;
    ...
    static {
        ...
        log.info("[ ZERO ] Environment On = {}, Path = {}", environment, vPath);
        ...
        // 六维数据专用
        HEX = ArmsSix.create(CONFIGURATION);
        // stellar 专用数据
