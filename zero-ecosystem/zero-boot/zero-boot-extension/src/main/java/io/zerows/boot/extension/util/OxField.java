    ...
    private static final Set<String> IGNORE_FIELDS = new HashSet<String>() {
        {
            ...
            this.add(OxConstant.Field.CONFIRM_STATUS);
            this.add(OxConstant.Field.LIFE_CYCLE);
    ...
    private static final Set<String> IGNORE_API = new HashSet<String>() {
        {
            this.add(KName.KEY);
            this.add(KName.CODE);
            this.add(OxConstant.Field.CATEGORY_THIRD);
            this.add(OxConstant.Field.CATEGORY_SECOND);
            this.add(OxConstant.Field.CATEGORY_FIRST);
            /* confirmStatus，在 Tracking 中取消 */
            this.add(OxConstant.Field.LIFE_CYCLE);
            this.add(OxConstant.Field.CONFIRM_STATUS);
        }
