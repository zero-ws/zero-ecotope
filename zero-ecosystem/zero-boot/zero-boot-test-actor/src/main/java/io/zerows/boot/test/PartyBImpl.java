 ...
 */
class PartyBImpl extends PartyBBase {
    /**
     ...
     */
    PartyBImpl(final PartyA partyA, final KIntegration integration) {
        super(partyA);
        this.integration = integration;
        this.dict = EAnvoy.ofBDict(integration);
        this.mapping = EAnvoy.ofBMap(integration);
        this.options = EAnvoy.ofBOption(integration);
    }
    ...
    public <CHILD extends PartyB> CHILD copy() {
        final PartyBImpl okB = new PartyBImpl(this.partyA, this.integration.copy());
