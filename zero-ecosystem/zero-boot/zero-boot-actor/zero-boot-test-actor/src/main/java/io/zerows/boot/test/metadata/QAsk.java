...
public class QAsk implements Serializable {
    ...
    /**
     * Zero专用日志器，{@link LogOf}
     */
    private static final LogOf LOGGER = LogOf.get(QAsk.class);
    /**
     ...
     */
    public QAsk(final DataAtom atom, final JsonObject data) {
        this.atom = atom;
     ...
     */
    public QAsk(final DataAtom atom, final String key) {
        this.atom = atom;
        this.key = key;
    }
     ...
     */
    public QAsk(final DataAtom atom, final JsonArray data) {
        this.atom = atom;
