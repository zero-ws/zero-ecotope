package io.zerows.epoch.bootplus.extension.uca.plugin;
...
public class SwitcherAgile {
    ...
    public SwitcherAgile() {
        this.dynamic = false;
    }

    public SwitcherAgile bind(final Switcher switcher) {
        this.switcher = switcher;
        this.dynamic = true;
        return this;
    }

    public SwitcherAgile initialize(final DataAtom atom, final HDao dao) {
        this.atom = atom;
        this.dao = dao;
        return this;
    }
