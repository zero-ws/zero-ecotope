...
public class ZeroConfigOn implements HConfig.HOn<ZeroConfigStandalone> {
    ...
    public static ZeroConfigStandalone configuration() {
     ...
     */
    @Override
    public Boolean configure(final ZeroConfigStandalone config) {
        // 1. 环境初始化
        Electy.initialize();
    ...
    @Override
    public ZeroConfigStandalone store() {
    ...
    @Override
    public HConfig.HOn<ZeroConfigStandalone> args(final String[] args) {
        this.arguments = args;
        return this;
    }
}
