...
public interface VName {
    ...
    String SUBJECT = "subject";                  /* Common: subject of envelop or message */
    String CONTENT = "content";                  /* Common: content of message */
    String ROBIN = "robin";
    ...
    String MAPPING = "mapping";                  /* Common: InJson mapping configuration */
    ...
    String SHAPE = "shape";                      /* Shared: shape of description for some specific object */
    ...
    String SETTING = "setting";                  /* Setting */
    ...
    // Store Path/Root
    String STORE = "get";                      /* File Management, Store */
    ...
    interface __ {
        ...
        String INHERIT = "__inherit";                /* __inherit 继承的数据结构 */
    }
}
