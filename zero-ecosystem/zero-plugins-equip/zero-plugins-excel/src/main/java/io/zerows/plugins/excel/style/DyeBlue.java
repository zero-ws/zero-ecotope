package io.zerows.plugins.excel.style;
 ...
 */
class DyeBlue {
    private static final Cc<Integer, DyeBlue> CC_PICKER = Cc.open();
    /*
     * Fix Issue:
    ...
    private DyeBlue(final Workbook workbook) {
    ...
    static DyeBlue get(final Workbook workbook) {
        return CC_PICKER.pick(() -> new DyeBlue(workbook), workbook.hashCode());
        // FnZero.po?l(PICKER_POOL, workbook.hashCode(), () -> new BlueDye(workbook));
    }
