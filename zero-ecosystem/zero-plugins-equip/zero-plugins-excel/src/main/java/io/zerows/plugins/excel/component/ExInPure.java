 ...
 */
public class ExInPure extends ExInBase {

    public ExInPure(final Sheet sheet) {
        super(sheet);
    }
    ...
    public ExBound applyTable(final ExTable table, final Row row, final Cell cell, final Integer limitation) {
        ...
        ExFn.onRow(this.sheet, row.getRowNum() + 2, foundRow -> {
            /* Build Field Col */
            final ExBound bound = new ExBoundCol(cell.getColumnIndex(), foundRow.getLastCellNum());
    ...
    public ExTable applyData(final ExTable table, final ExBound dataRange, final Cell cell, final HMetaAtom metaAtom) {
        ...
        ExFn.itSheet(this.sheet, dataRange, (dataRow, rowIndex) -> {
            ...
            final ExBound bound = new ExBoundCol(cell.getColumnIndex(),
