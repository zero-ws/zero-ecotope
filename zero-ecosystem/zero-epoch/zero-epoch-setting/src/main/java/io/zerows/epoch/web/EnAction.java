...
import io.zerows.epoch.web.exception._60049Exception500HttpWeb;
...
class EnAction {
    ...
    static void inMe(final Envelop envelopRef, final EmValue.Bool active, final boolean app) {
        ...
        // this.findRunning(KName.ACTIVE, active);
    ...
    static void copyFrom(final EnAssist assistRef, final RoutingContext context) {
