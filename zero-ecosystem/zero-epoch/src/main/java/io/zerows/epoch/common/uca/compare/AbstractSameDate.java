...
abstract class AbstractSameDate extends AbstractSame {
    ...
    public boolean isAnd(final Object valueOld, final Object valueNew) {
         ...
         */
        final Instant oldInstant = UtBase.parseFull(valueOld.toString())
            .toInstant();
        final Instant newInstant = UtBase.parseFull(valueNew.toString())
            .toInstant();
        /*
         * Compared by unit
         */
        final LocalDateTime datetimeOld = UtBase.toDateTime(oldInstant);
        final LocalDateTime datetimeNew = UtBase.toDateTime(newInstant);
