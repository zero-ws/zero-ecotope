...
public class Vs implements Serializable {
    ...
    public boolean isChange(final JsonObject previous, final JsonObject current) {
        ...
        final JsonObject oldCopy = UtBase.valueJObject(previous).copy();
        final JsonObject newCopy = UtBase.valueJObject(current).copy();
    ...
    public boolean isChange(final JsonObject twins) {
        final JsonObject secure = UtBase.valueJObject(twins);
