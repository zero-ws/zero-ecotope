package io.zerows.epoch.common.uca.qr;
...
public class Sorter implements Serializable {
    ...
    public static Sorter create(final JsonArray sorter) {
        ...
        UtBase.itJArray(sorter, String.class).forEach((field) -> {
    ...
    public static Sorter create(final JsonObject sorterJ) {
        if (UtBase.isNil(sorterJ)) {
            return null;
        }
        final Sorter sorter = create();
        UtBase.itJObject(sorterJ, Boolean.class).forEach((entry) ->
    ...
    public String toString() {
        ...
        return VString.LEFT_SQUARE + UtBase.fromJoin(kv) + VString.RIGHT_SQUARE;
    }
}
