...
public class ZeroHttpAgent extends AbstractVerticle {
    ...
    public void start() {
        ...
        //        final RunVertxLegacy runVertxLegacy = StoreVertxLegacy.ofOr(this.getClass()).valueGet(this.vertx.hashCode());
        //
        //        /* 构造运行的服务器 */
        //        final StubServer stubServer = StubServer.of(this.bundle);
        //        final Set<RunServerLegacy> serverWait = stubServer.createAsync(runVertxLegacy);
