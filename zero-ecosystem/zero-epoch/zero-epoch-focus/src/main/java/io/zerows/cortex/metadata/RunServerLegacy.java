 ...
 */
@Deprecated
public class RunServerLegacy implements RunInstance<HttpServer> {
    ...
    private RunVertxLegacy refVertx;

    public RunServerLegacy(final String name) {
        this.name = name;
    }
    ...
    public RunVertxLegacy refRunVertx() {
        return this.refVertx;
    }

    public RunServerLegacy refRunVertx(final RunVertxLegacy vertx) {
        this.refVertx = vertx;
        return this;
    }

    public RunServerLegacy config(final OptionOfServer<HttpServerOptions> optionOfServer) {
        this.optionOfServer = optionOfServer;
        return this;
    }

    public RunServerLegacy configSock(final OptionOfServer<SockOptions> optionOfSock) {
    ...
    public RunServerLegacy build() {
        if (Objects.isNull(this.server.requestHandler())) {
            final RunVertxLegacy runVertxLegacy = this.refVertx;
            final Router router = Router.router(runVertxLegacy.instance());
    ...
    public RunServerLegacy instance(final HttpServer server) {
        this.server = server;
        return this;
    }
    ...
    public boolean equals(final Object o) {
        ...
        final RunServerLegacy runServerLegacy = (RunServerLegacy) o;
        return Objects.equals(this.server, runServerLegacy.server);
    }
