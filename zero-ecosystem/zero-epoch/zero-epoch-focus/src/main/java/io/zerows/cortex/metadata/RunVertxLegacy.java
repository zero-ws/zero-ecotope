 ...
 * <pre><code>
 *     Cluster
 *      - Vertx-01 ...                              {@link RunVertxLegacy}  x 1
 *        - deploymentId-01-01 = Class<?>           {@link io.vertx.core.Verticle} x N
 *        - deploymentId-01-02 =
 *        - serverName =                            {@link RunServerLegacy} x N
 ...
 */
@Deprecated
public class RunVertxLegacy implements RunInstance<Vertx> {

    private final String name;
    private final ConcurrentMap<String, Class<?>> deploymentMap = new ConcurrentHashMap<>();
    private Vertx vertxRef;
    private NodeVertxLegacy vertxConfig;

    public RunVertxLegacy(final String name) {
        this.name = name;
    }
    ...
    public RunVertxLegacy config(final NodeVertxLegacy vertxConfig) {
    ...
    public RunVertxLegacy instance(final Vertx vertx) {
        this.vertxRef = vertx;
        return this;
    }
