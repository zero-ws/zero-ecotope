...
public class Phase {
    ...
    /* Phase */
    private transient PhaseInput input;
    private transient PhaseRunOn runOn;
    private transient PhaseOutPut output;
    ...
    public Phase bind(final Vertx vertx) {
        this.vertx = vertx;
        this.input = new PhaseInput(this.vertx);
        this.runOn = new PhaseRunOn(this.vertx);
        this.output = new PhaseOutPut(this.vertx);
        return this;
    }
    ...
    public Future<Envelop> outputAsync(final Envelop envelop) {
        ...
        return this.output.bind(this.input.underway())
            .outputAsync(envelop, this.mission, this.vertx);
    }
