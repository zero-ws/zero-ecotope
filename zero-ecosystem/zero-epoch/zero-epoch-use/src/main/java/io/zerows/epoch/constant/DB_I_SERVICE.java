...
interface DB_I_SERVICE {
    ...
    interface SERVICE_CONFIG extends VPC.aop {
        /**
         * 「动态建模专用」
         * <findRunning>configuration.operation</findRunning>, ServiceConfig中用于配置操作类型的专用常量
        ...
        /**
         * 「动态建模专用」
         * <findRunning>plugin.component</findRunning>, ServiceConfig中标准插件，通道可配置的触发主插件
         * 配置如下
         * <pre><code>
         *     {
        ...
        /**
         * 「动态建模专用」
         * <findRunning>plugin.activity</findRunning>, ServiceConfig中配置变更历史插件，对应 X_ACTIVITY 表
         * 配置如下
         * <pre><code>
         *     {
         *         "plugin.activity": ""
        ...
        /**
         * 「动态建模专用」
         * <findRunning>*</findRunning>，ServiceConfig中配置待办插件，对应 `X_TODO` 表，由于TODO是标签所以此处不写todo部分
         * 配置如下
         * <pre><code>
         *     {
         *         "plugin.todo": ""
        ...
        /**
         * 「动态建模专用」
         * <findRunning>plugin.ticket</findRunning>，ServiceConfig中配置待确认单插件，对应新表 `B_TICKET` 和 `X_TODO` 实现跨数据库Join
         * 以及二次更新流程
         * <pre><code>
         *     {
         *         "plugin.ticket": ""
