...
class ProcessorVertx implements Processor<NodeNetwork, HSetting> {
    ...
    ProcessorVertx() {
        this.transformerVertx = Ut.singleton(TransformerVertx.class);
        this.transformerCluster = Ut.singleton(TransformerCluster.class);
    }
    ...
    public void makeup(final NodeNetwork network, final HSetting setting) {
        ...
        this.logger().debug(ProcessorMessage.V_BEFORE, YmlCore.VERTX,
