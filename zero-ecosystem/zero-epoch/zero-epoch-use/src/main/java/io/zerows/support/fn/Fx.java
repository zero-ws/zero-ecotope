...
public final class Fx extends FnBase {
    private Fx() {
    }
    ...
    public static <J, A> Future<JsonObject> combineJ(
        ...
        return FnVertx.combineJ(input, field, itemOrJ, itemOrA);
    }
    ...
    public static Future<JsonArray> combineA(
        ...
        return FnVertx.combineA(source, generateOf, combinerOf);
    }
    ...
    public static Future<JsonArray> combineA(final JsonArray input,
        ...
        return FnVertx.combineA(input, generateOf);
    }
    ...
    public static Future<JsonArray> combineA(final List<Future<JsonObject>> source) {
        return FnVertx.combineA(source);
    }
    ...
    public static <T> Future<JsonArray> combineA_(final JsonArray source, final Class<T> clazz,
        ...
        return FnVertx.compressA(futures);
    }
    ...
    public static Future<JsonObject> combineJ(final Future<JsonObject>... futures) {
        return FnVertx.combineJ(futures);
    }
    ...
    public static Future<JsonObject> combineJ_(
        ...
        return FnVertx.combineJ(source, generateOf, combinerOf);
    }
    ...
    public static Future<JsonObject> combineJ_(
        ...
        return FnVertx.combineJ(Future.succeededFuture(source), generateFun, operatorFun);
    }
    ...
    public static <T> Future<List<T>> compressL(final List<Future<List<T>>> futures) {
        return FnVertx.compressL(futures);
    }
