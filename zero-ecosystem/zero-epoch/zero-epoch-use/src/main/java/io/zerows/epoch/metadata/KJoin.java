 ...
 *         "ofMain": {
 *             "identifier1": {@link Point},
 *             "identifier2": {@link Point}
 *         }
 *     }
 * }
 * </code></pre>
...
public class KJoin implements Serializable {
    ...
    public void setReference(final Point reference) {
        this.reference = reference;
    }

    public ConcurrentMap<String, Point> getTarget() {
        return this.target;
    }

    public void setTarget(final ConcurrentMap<String, Point> target) {
        this.target = target;
    }
    ...
    /**
     * 连接点专用配置，所有连接点配置一致 {@link Point} ，都是固定数据结构：
     * <pre><code>
     * {
    ...
    public static class Point implements Serializable {
        ...
        public KMap.Node synonym() {
            return new KMap.Node(this.synonym);
        }
