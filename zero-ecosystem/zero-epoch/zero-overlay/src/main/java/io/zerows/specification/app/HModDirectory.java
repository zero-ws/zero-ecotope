 ...
 * @author lang
 */
public interface HModDirectory {
        ...
        interface mod {
            ...
            interface oob {
                ...
                static String initialize_json(final String mod) {
                    return UtBase.fromMessage(plugin.mod.oob.of(mod) + "/initialize.json");
                }

                // plugin/{module}/oob/initialize.yml
                static String initialize_yml(final String mod) {
                    return UtBase.fromMessage(plugin.mod.oob.of(mod) + "/initialize.yml");
                }

                // plugin/{module}/oob/module.json
                static String module_json(final String mod) {
                    return UtBase.fromMessage(plugin.mod.oob.of(mod) + "/module.json");
                }
            }
        }
