...
public interface Agonic {
    ...
    static Agonic file() {
        return Pooled.CCT_AGONIC.pick(AgonicADBImport::new, AgonicADBImport.class.getName());
    }

    static Agonic get() {
        return Pooled.CCT_AGONIC.pick(AgonicADBByID::new, AgonicADBByID.class.getName());
    }

    static Agonic search() {
        return Pooled.CCT_AGONIC.pick(AgonicADJSearch::new, AgonicADJSearch.class.getName());
    }

    static Agonic count() {
        return Pooled.CCT_AGONIC.pick(AgonicADJCount::new, AgonicADJCount.class.getName());
    }
    ...
    static Agonic fetch() {
        return Pooled.CCT_AGONIC.pick(AgonicADJFetch::new, AgonicADJFetch.class.getName());
    }
