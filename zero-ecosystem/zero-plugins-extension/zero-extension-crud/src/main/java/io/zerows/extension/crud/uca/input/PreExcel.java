...
import io.zerows.extension.crud.exception._80102Exception409MultiModule;
import io.zerows.extension.crud.exception._80103Exception409ModuleConflict;
 ...
 */
class PreExcel implements Pre {
    private transient final ExcelClient client;

    PreExcel(final ExcelClient client) {
        this.client = client;
    }
