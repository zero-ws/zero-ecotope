...
public class Assembler {
    ...
    private static JsonObject bindResult(final JsonArray permissions,
        ...
        profile.put(ScAuthKey.PROFILE_PERM, Objects.isNull(permissions) ? new JsonArray() : permissions);
        profile.put(ScAuthKey.PROFILE_ROLE, Objects.isNull(roles) ? new JsonArray() : roles);
        return profile;
    }
