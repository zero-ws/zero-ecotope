...
import io.zerows.plugins.security.weco.WeComAsyncUserAt;
import jakarta.inject.Inject;

/**
 * @author lang : 2025-12-11
 */
@SPID("UserAt/ID_WECOM")
public class UserAtWeCom extends WeComAsyncUserAt {
    @Inject
    private UserAuthStub userStub;

    @Override
    public Future<UserAt> findUser(final String unionId) {
        return this.userStub.whereBy(unionId, TypeLogin.ID_WECOM)
            // 构造 UserAt 对象
