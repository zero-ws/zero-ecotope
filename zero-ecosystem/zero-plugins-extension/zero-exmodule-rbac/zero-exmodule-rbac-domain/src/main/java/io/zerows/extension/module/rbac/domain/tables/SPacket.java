...
public class SPacket extends TableImpl<SPacketRecord> {
    ...
    /**
     * The column <code>ZDB.S_PACKET.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    public final TableField<SPacketRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 用户组绑定的统一标识");
    /**
     ...
     */
    public final TableField<SPacketRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
    /**
