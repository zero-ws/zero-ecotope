...
public class SVisitantRecord extends UpdatableRecordImpl<SVisitantRecord> implements VertxPojo, ISVisitant {
     ...
     */
    @Override
    public SVisitantRecord setKey(final String value) {
        set(0, value);
        return this;
    }
     ...
     */
    @Override
    public SVisitantRecord setViewId(final String value) {
        set(1, value);
        return this;
    }
     ...
     */
    @Override
    public SVisitantRecord setMode(final String value) {
        set(2, value);
        return this;
    }
     ...
     */
    @Override
    public SVisitantRecord setPhase(final String value) {
        set(3, value);
        return this;
    }
     ...
     */
    @Override
    public SVisitantRecord setType(final String value) {
        set(4, value);
        return this;
    }
     ...
     */
    @Override
    public SVisitantRecord setIdentifier(final String value) {
        set(5, value);
        return this;
    }
     ...
     */
    @Override
    public SVisitantRecord setSeekKey(final String value) {
        set(6, value);
        return this;
    }
     ...
     */
    @Override
    public SVisitantRecord setDmRow(final String value) {
        set(7, value);
        return this;
    }
     ...
     */
    @Override
    public SVisitantRecord setDmQr(final String value) {
        set(8, value);
        return this;
    }
     ...
     */
    @Override
    public SVisitantRecord setDmColumn(final String value) {
        set(9, value);
        return this;
    }
     ...
     */
    @Override
    public SVisitantRecord setAclVisible(final String value) {
        set(10, value);
        return this;
    }
     ...
     */
    @Override
    public SVisitantRecord setAclView(final String value) {
        set(11, value);
        return this;
    }
     ...
     */
    @Override
    public SVisitantRecord setAclVariety(final String value) {
        set(12, value);
        return this;
    }
     ...
     */
    @Override
    public SVisitantRecord setAclVow(final String value) {
        set(13, value);
        return this;
    }
     ...
     */
    @Override
    public SVisitantRecord setAclVerge(final String value) {
        set(14, value);
        return this;
    }
     ...
     */
    @Override
    public SVisitantRecord setSigma(final String value) {
        set(15, value);
        return this;
    }
     ...
     */
    @Override
    public SVisitantRecord setLanguage(final String value) {
        set(16, value);
        return this;
    }
     ...
     */
    @Override
    public SVisitantRecord setActive(final Boolean value) {
        set(17, value);
        return this;
    }
     ...
     */
    @Override
    public SVisitantRecord setMetadata(final String value) {
        set(18, value);
        return this;
    }
     ...
     */
    @Override
    public SVisitantRecord setCreatedAt(final LocalDateTime value) {
        set(19, value);
        return this;
    }
     ...
     */
    @Override
    public SVisitantRecord setCreatedBy(final String value) {
        set(20, value);
        return this;
    }
     ...
     */
    @Override
    public SVisitantRecord setUpdatedAt(final LocalDateTime value) {
        set(21, value);
        return this;
    }
     ...
     */
    @Override
    public SVisitantRecord setUpdatedBy(final String value) {
        set(22, value);
        return this;
    }
    ...
    @Override
    public void from(final ISVisitant from) {
        setKey(from.getKey());
    ...
    @Override
    public <E extends ISVisitant> E into(final E into) {
        into.from(this);
        return into;
    }
     ...
     */
    public SVisitantRecord(final String key, final String viewId, final String mode, final String phase, final String type, final String identifier, final String seekKey, final String dmRow, final String dmQr, final String dmColumn, final String aclVisible, final String aclView, final String aclVariety, final String aclVow, final String aclVerge, final String sigma, final String language, final Boolean active, final String metadata, final LocalDateTime createdAt, final String createdBy, final LocalDateTime updatedAt, final String updatedBy) {
        super(SVisitant.S_VISITANT);
     ...
     * Create a detached, initialised SVisitantRecord
     */
    public SVisitantRecord(final io.zerows.extension.module.rbac.domain.tables.pojos.SVisitant value) {
        super(SVisitant.S_VISITANT);
    ...
    public SVisitantRecord(final io.vertx.core.json.JsonObject json) {
        this();
        fromJson(json);
    }
}
