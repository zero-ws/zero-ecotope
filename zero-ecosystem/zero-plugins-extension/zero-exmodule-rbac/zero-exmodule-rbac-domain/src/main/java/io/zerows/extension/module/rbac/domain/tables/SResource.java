...
public class SResource extends TableImpl<SResourceRecord> {
     ...
     */
    public final TableField<SResourceRecord, String> COMMENT = createField(DSL.name("COMMENT"), SQLDataType.CLOB(65535), this, "「comment」- 备注信息");
    /**
    ...
    /**
     * The column <code>ZDB.S_RESOURCE.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    public final TableField<SResourceRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 用户组绑定的统一标识");
    /**
     ...
     */
    public final TableField<SResourceRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
    /**
