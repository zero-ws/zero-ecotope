...
public class SVisitant extends TableImpl<SVisitantRecord> {
    ...
    /**
     * The column <code>ZDB.S_VISITANT.ID</code>. 「id」- 主键
     */
    public final TableField<SVisitantRecord, String> ID = createField(DSL.name("ID"), SQLDataType.VARCHAR(36).nullable(false), this, "「id」- 主键");
    ...
    /**
     * The column <code>ZDB.S_VISITANT.MODE</code>. 「mode」- 模式
     */
    public final TableField<SVisitantRecord, String> MODE = createField(DSL.name("MODE"), SQLDataType.VARCHAR(36), this, "「mode」- 模式");
    ...
    /**
     * The column <code>ZDB.S_VISITANT.TYPE</code>. 「type」- 类型
     */
    public final TableField<SVisitantRecord, String> TYPE = createField(DSL.name("TYPE"), SQLDataType.VARCHAR(128), this, "「type」- 类型");

    /**
     * The column <code>ZDB.S_VISITANT.SIGMA</code>. 「sigma」- 统一标识
     */
    public final TableField<SVisitantRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 统一标识");
    ...
    /**
     * The column <code>ZDB.S_VISITANT.LANGUAGE</code>. 「language」- 语言偏好
     */
    public final TableField<SVisitantRecord, String> LANGUAGE = createField(DSL.name("LANGUAGE"), SQLDataType.VARCHAR(10), this, "「language」- 语言偏好");

    /**
     * The column <code>ZDB.S_VISITANT.METADATA</code>. 「metadata」- 元配置
     */
    public final TableField<SVisitantRecord, JsonObject> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 元配置", new JooqJsonObjectConverter());

    /**
     * The column <code>ZDB.S_VISITANT.VERSION</code>. 「version」- 版本号
     */
    public final TableField<SVisitantRecord, String> VERSION = createField(DSL.name("VERSION"), SQLDataType.VARCHAR(64), this, "「version」- 版本号");
    ...
    private SVisitant(Name alias, Table<SVisitantRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment("S_VISITANT"), TableOptions.table(), where);
    }
    ...
    public List<UniqueKey<SVisitantRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_S_VISITANT_UK_S_VISITANT_VIEW_ID_TYPE_SEEK_KEY);
    }
