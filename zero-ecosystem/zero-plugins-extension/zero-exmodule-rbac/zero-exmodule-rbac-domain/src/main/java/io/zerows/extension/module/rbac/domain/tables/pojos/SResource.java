...
public class SResource implements VertxPojo, ISResource {
    ...
    public SResource(final ISResource value) {
    ...
    public SResource(
        ...
        final Integer level,
        final String modeRole,
        final String modeGroup,
        final String modeTree,
        final Boolean virtual,
        final String seekSyntax,
        final String seekConfig,
        final String seekComponent,
        final String sigma,
    ...
    public SResource(final io.vertx.core.json.JsonObject json) {
        this();
        fromJson(json);
    }
     ...
     */
    @Override
    public SResource setKey(final String key) {
        this.key = key;
        return this;
    }
     ...
     */
    @Override
    public SResource setCode(final String code) {
        this.code = code;
        return this;
    }
     ...
     */
    @Override
    public SResource setName(final String name) {
        this.name = name;
        return this;
    }
     ...
     */
    @Override
    public SResource setType(final String type) {
        this.type = type;
        return this;
    }
     ...
     */
    @Override
    public SResource setIdentifier(final String identifier) {
        this.identifier = identifier;
        return this;
    }
     ...
     */
    @Override
    public SResource setComment(final String comment) {
        this.comment = comment;
        return this;
    }
     ...
     */
    @Override
    public SResource setLevel(final Integer level) {
        this.level = level;
        return this;
    }
     ...
     */
    @Override
    public SResource setModeRole(final String modeRole) {
        this.modeRole = modeRole;
        return this;
    }
     ...
     */
    @Override
    public SResource setModeGroup(final String modeGroup) {
        this.modeGroup = modeGroup;
        return this;
    }
     ...
     */
    @Override
    public SResource setModeTree(final String modeTree) {
        this.modeTree = modeTree;
        return this;
    }
     ...
     */
    @Override
    public SResource setVirtual(final Boolean virtual) {
        this.virtual = virtual;
        return this;
    }
     ...
     */
    @Override
    public SResource setSeekSyntax(final String seekSyntax) {
        this.seekSyntax = seekSyntax;
        return this;
    }
     ...
     */
    @Override
    public SResource setSeekConfig(final String seekConfig) {
        this.seekConfig = seekConfig;
        return this;
    }
     ...
     */
    @Override
    public SResource setSeekComponent(final String seekComponent) {
        this.seekComponent = seekComponent;
        return this;
    }
     ...
     */
    @Override
    public SResource setSigma(final String sigma) {
        this.sigma = sigma;
        return this;
    }
     ...
     */
    @Override
    public SResource setCategory(final String category) {
        this.category = category;
        return this;
    }
     ...
     */
    @Override
    public SResource setLanguage(final String language) {
        this.language = language;
        return this;
    }
     ...
     */
    @Override
    public SResource setActive(final Boolean active) {
        this.active = active;
        return this;
    }
     ...
     */
    @Override
    public SResource setMetadata(final String metadata) {
        this.metadata = metadata;
        return this;
    }
     ...
     */
    @Override
    public SResource setCreatedAt(final LocalDateTime createdAt) {
        this.createdAt = createdAt;
        return this;
    }
     ...
     */
    @Override
    public SResource setCreatedBy(final String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     */
    @Override
    public SResource setUpdatedAt(final LocalDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
     ...
     */
    @Override
    public SResource setUpdatedBy(final String updatedBy) {
        this.updatedBy = updatedBy;
        return this;
    }
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("SResource (");
    ...
    @Override
    public void from(final ISResource from) {
        setKey(from.getKey());
    ...
    @Override
    public <E extends ISResource> E into(final E into) {
        into.from(this);
        return into;
    }
}
