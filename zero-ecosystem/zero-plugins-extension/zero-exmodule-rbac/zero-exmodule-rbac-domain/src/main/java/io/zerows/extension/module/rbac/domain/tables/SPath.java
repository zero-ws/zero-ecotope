...
public class SPath extends TableImpl<SPathRecord> {
     ...
     */
    public final TableField<SPathRecord, String> MAPPING = createField(DSL.name("MAPPING"), SQLDataType.CLOB(65535), this, "「mapping」- 从 dm -> ui 转换");
     ...
     */
    public final TableField<SPathRecord, String> DM_CONFIG = createField(DSL.name("DM_CONFIG"), SQLDataType.CLOB(65535), this, "「dmConfig」- 组配置信息，配置呈现部分");
     ...
     */
    public final TableField<SPathRecord, String> UI_SURFACE = createField(DSL.name("UI_SURFACE"), SQLDataType.CLOB(65535), this, "「uiSurface」- 界面呈现模式，已经被降维之后（列表、树、其他等相关配置）");
    ...
    /**
     * The column <code>ZDB.S_PATH.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    public final TableField<SPathRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 用户组绑定的统一标识");
     ...
     */
    public final TableField<SPathRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
