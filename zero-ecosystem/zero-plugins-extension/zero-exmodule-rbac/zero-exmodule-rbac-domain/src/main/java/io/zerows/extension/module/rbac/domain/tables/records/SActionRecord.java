...
public class SActionRecord extends UpdatableRecordImpl<SActionRecord> implements VertxPojo, Record18<String, String, String, String, String, Integer, String, String, String, String, String, Boolean, String, String, LocalDateTime, String, LocalDateTime, String>, ISAction {
     ...
     */
    @Override
    public SActionRecord setKey(final String value) {
        set(0, value);
        return this;
    }
     ...
     */
    @Override
    public SActionRecord setName(final String value) {
        set(1, value);
        return this;
    }
     ...
     */
    @Override
    public SActionRecord setCode(final String value) {
        set(2, value);
        return this;
    }
     ...
     */
    @Override
    public SActionRecord setResourceId(final String value) {
        set(3, value);
        return this;
    }
     ...
     */
    @Override
    public SActionRecord setPermissionId(final String value) {
        set(4, value);
        return this;
    }
     ...
     */
    @Override
    public SActionRecord setLevel(final Integer value) {
        set(5, value);
        return this;
    }
     ...
     */
    @Override
    public SActionRecord setUri(final String value) {
        set(6, value);
        return this;
    }
     ...
     */
    @Override
    public SActionRecord setMethod(final String value) {
        set(7, value);
        return this;
    }
     ...
     */
    @Override
    public SActionRecord setSigma(final String value) {
        set(8, value);
        return this;
    }
     ...
     */
    @Override
    public SActionRecord setRenewalCredit(final String value) {
        set(9, value);
        return this;
    }
     ...
     */
    @Override
    public SActionRecord setLanguage(final String value) {
        set(10, value);
        return this;
    }
     ...
     */
    @Override
    public SActionRecord setActive(final Boolean value) {
        set(11, value);
        return this;
    }
     ...
     */
    @Override
    public SActionRecord setMetadata(final String value) {
        set(12, value);
        return this;
    }
     ...
     */
    @Override
    public SActionRecord setComment(final String value) {
        set(13, value);
        return this;
    }
     ...
     */
    @Override
    public SActionRecord setCreatedAt(final LocalDateTime value) {
        set(14, value);
        return this;
    }
     ...
     */
    @Override
    public SActionRecord setCreatedBy(final String value) {
        set(15, value);
        return this;
    }
     ...
     */
    @Override
    public SActionRecord setUpdatedAt(final LocalDateTime value) {
        set(16, value);
        return this;
    }
     ...
     */
    @Override
    public SActionRecord setUpdatedBy(final String value) {
        set(17, value);
        return this;
    }
    ...
    @Override
    public SActionRecord value1(final String value) {
        setKey(value);
        return this;
    }

    @Override
    public SActionRecord value2(final String value) {
        setName(value);
        return this;
    }

    @Override
    public SActionRecord value3(final String value) {
        setCode(value);
        return this;
    }

    @Override
    public SActionRecord value4(final String value) {
        setResourceId(value);
        return this;
    }

    @Override
    public SActionRecord value5(final String value) {
        setPermissionId(value);
        return this;
    }

    @Override
    public SActionRecord value6(final Integer value) {
        setLevel(value);
        return this;
    }

    @Override
    public SActionRecord value7(final String value) {
        setUri(value);
        return this;
    }

    @Override
    public SActionRecord value8(final String value) {
        setMethod(value);
        return this;
    }

    @Override
    public SActionRecord value9(final String value) {
        setSigma(value);
        return this;
    }

    @Override
    public SActionRecord value10(final String value) {
        setRenewalCredit(value);
        return this;
    }

    @Override
    public SActionRecord value11(final String value) {
        setLanguage(value);
        return this;
    }

    @Override
    public SActionRecord value12(final Boolean value) {
        setActive(value);
        return this;
    }

    @Override
    public SActionRecord value13(final String value) {
        setMetadata(value);
        return this;
    }

    @Override
    public SActionRecord value14(final String value) {
        setComment(value);
        return this;
    }

    @Override
    public SActionRecord value15(final LocalDateTime value) {
        setCreatedAt(value);
        return this;
    }

    @Override
    public SActionRecord value16(final String value) {
        setCreatedBy(value);
        return this;
    }

    @Override
    public SActionRecord value17(final LocalDateTime value) {
        setUpdatedAt(value);
        return this;
    }

    @Override
    public SActionRecord value18(final String value) {
        setUpdatedBy(value);
        return this;
    }

    @Override
    public SActionRecord values(final String value1, final String value2, final String value3, final String value4, final String value5, final Integer value6, final String value7, final String value8, final String value9, final String value10, final String value11, final Boolean value12, final String value13, final String value14, final LocalDateTime value15, final String value16, final LocalDateTime value17, final String value18) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    @Override
    public void from(final ISAction from) {
        setKey(from.getKey());
    ...
    @Override
    public <E extends ISAction> E into(final E into) {
        into.from(this);
        return into;
    }
     ...
     */
    public SActionRecord(final String key, final String name, final String code, final String resourceId, final String permissionId, final Integer level, final String uri, final String method, final String sigma, final String renewalCredit, final String language, final Boolean active, final String metadata, final String comment, final LocalDateTime createdAt, final String createdBy, final LocalDateTime updatedAt, final String updatedBy) {
        super(SAction.S_ACTION);
     ...
     * Create a detached, initialised SActionRecord
     */
    public SActionRecord(final io.zerows.extension.module.rbac.domain.tables.pojos.SAction value) {
        super(SAction.S_ACTION);
    ...
    public SActionRecord(final io.vertx.core.json.JsonObject json) {
        this();
        fromJson(json);
    }
}
