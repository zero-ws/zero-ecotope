...
public class SVisitantDao extends AbstractVertxDAO<SVisitantRecord, io.zerows.extension.module.rbac.domain.tables.pojos.SVisitant, String, Future<List<io.zerows.extension.module.rbac.domain.tables.pojos.SVisitant>>, Future<io.zerows.extension.module.rbac.domain.tables.pojos.SVisitant>, Future<Integer>, Future<String>> implements io.r2mo.vertx.jooq.classic.VertxDAO<SVisitantRecord,io.zerows.extension.module.rbac.domain.tables.pojos.SVisitant,String> {
     ...
     */
        public Future<List<io.zerows.extension.module.rbac.domain.tables.pojos.SVisitant>> findManyByMetadata(Collection<String> values) {
     ...
     * limited by the given limit
     */
        public Future<List<io.zerows.extension.module.rbac.domain.tables.pojos.SVisitant>> findManyByMetadata(Collection<String> values, int limit) {
