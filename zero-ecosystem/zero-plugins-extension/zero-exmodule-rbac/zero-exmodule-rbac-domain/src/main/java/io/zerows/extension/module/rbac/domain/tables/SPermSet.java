...
public class SPermSet extends TableImpl<SPermSetRecord> {
     ...
     */
    public final TableField<SPermSetRecord, String> COMMENT = createField(DSL.name("COMMENT"), SQLDataType.CLOB(65535), this, "「comment」- 权限集说明");
    /**
     * The column <code>ZDB.S_PERM_SET.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    public final TableField<SPermSetRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 用户组绑定的统一标识");
    /**
     ...
     */
    public final TableField<SPermSetRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
    /**
