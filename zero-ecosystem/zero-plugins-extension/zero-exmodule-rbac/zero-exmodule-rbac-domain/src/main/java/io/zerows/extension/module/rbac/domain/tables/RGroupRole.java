...
public class RGroupRole extends TableImpl<RGroupRoleRecord> {
    ...
    /**
     * The column <code>ZDB.R_GROUP_ROLE.PRIORITY</code>. 「priority」- 优先级
     */
    public final TableField<RGroupRoleRecord, Integer> PRIORITY = createField(DSL.name("PRIORITY"), SQLDataType.INTEGER, this, "「priority」- 优先级");
    ...
    private RGroupRole(Name alias, Table<RGroupRoleRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment("关联表"), TableOptions.table(), where);
    }
