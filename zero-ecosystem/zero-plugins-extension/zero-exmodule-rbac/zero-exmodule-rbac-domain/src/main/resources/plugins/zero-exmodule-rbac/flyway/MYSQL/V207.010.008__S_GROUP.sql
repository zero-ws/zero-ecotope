...
CREATE TABLE IF NOT EXISTS `S_GROUP` (
    ...
    `PARENT_ID`   VARCHAR(36)   COLLATE utf8mb4_bin DEFAULT NULL COMMENT '「parentId」- 父节点',              -- [关联] 组支持树形结构，角色平行结构
    ...
    UNIQUE KEY `UK_S_GROUP_CODE_SIGMA` (`CODE`, `SIGMA`) USING BTREE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_bin COMMENT='组';
