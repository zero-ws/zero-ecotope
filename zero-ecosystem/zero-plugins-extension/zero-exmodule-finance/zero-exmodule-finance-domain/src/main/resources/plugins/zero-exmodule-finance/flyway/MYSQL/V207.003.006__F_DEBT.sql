...
CREATE TABLE IF NOT EXISTS `F_DEBT` (
    -- ==================================================================================================
    ...
    UNIQUE KEY `UK_F_DEBT_CODE_SIGMA` (`CODE`, `SIGMA`) USING BTREE,
    UNIQUE KEY `UK_F_DEBT_SERIAL_SIGMA` (`SERIAL`, `SIGMA`) USING BTREE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_bin COMMENT='F_DEBT';
