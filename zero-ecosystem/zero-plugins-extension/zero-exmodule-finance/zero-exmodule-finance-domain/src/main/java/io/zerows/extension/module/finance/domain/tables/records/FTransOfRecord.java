...
public class FTransOfRecord extends UpdatableRecordImpl<FTransOfRecord> implements VertxPojo, Record4<String, String, String, String>, IFTransOf {
     ...
     */
    @Override
    public FTransOfRecord setTransId(final String value) {
        set(0, value);
        return this;
    }
     ...
     */
    @Override
    public FTransOfRecord setObjectType(final String value) {
        set(1, value);
        return this;
    }
     ...
     */
    @Override
    public FTransOfRecord setObjectId(final String value) {
        set(2, value);
        return this;
    }
     ...
     */
    @Override
    public FTransOfRecord setComment(final String value) {
        set(3, value);
        return this;
    }
    ...
    @Override
    public FTransOfRecord value1(final String value) {
        setTransId(value);
        return this;
    }

    @Override
    public FTransOfRecord value2(final String value) {
        setObjectType(value);
        return this;
    }

    @Override
    public FTransOfRecord value3(final String value) {
        setObjectId(value);
        return this;
    }

    @Override
    public FTransOfRecord value4(final String value) {
        setComment(value);
        return this;
    }

    @Override
    public FTransOfRecord values(final String value1, final String value2, final String value3, final String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    @Override
    public void from(final IFTransOf from) {
    ...
    @Override
    public <E extends IFTransOf> E into(final E into) {
        into.from(this);
        return into;
    }
     ...
     */
    public FTransOfRecord(final String transId, final String objectType, final String objectId, final String comment) {
        super(FTransOf.F_TRANS_OF);
     ...
     * Create a detached, initialised FTransOfRecord
     */
    public FTransOfRecord(final io.zerows.extension.module.finance.domain.tables.pojos.FTransOf value) {
        super(FTransOf.F_TRANS_OF);
    ...
    public FTransOfRecord(final io.vertx.core.json.JsonObject json) {
        this();
        fromJson(json);
    }
}
