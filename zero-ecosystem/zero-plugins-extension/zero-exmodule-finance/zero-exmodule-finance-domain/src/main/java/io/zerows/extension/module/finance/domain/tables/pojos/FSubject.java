...
public class FSubject implements VertxPojo, IFSubject {
    ...
    public FSubject(final IFSubject value) {
    ...
    public FSubject(final io.vertx.core.json.JsonObject json) {
        this();
        fromJson(json);
    }
     ...
     */
    @Override
    public FSubject setKey(final String key) {
        this.key = key;
        return this;
    }
     ...
     */
    @Override
    public FSubject setName(final String name) {
        this.name = name;
        return this;
    }
     ...
     */
    @Override
    public FSubject setCode(final String code) {
        this.code = code;
        return this;
    }
     ...
     */
    @Override
    public FSubject setSerial(final String serial) {
        this.serial = serial;
        return this;
    }
     ...
     */
    @Override
    public FSubject setCategory(final String category) {
        this.category = category;
        return this;
    }
     ...
     */
    @Override
    public FSubject setHelpCode(final String helpCode) {
        this.helpCode = helpCode;
        return this;
    }
     ...
     */
    @Override
    public FSubject setComment(final String comment) {
        this.comment = comment;
        return this;
    }
     ...
     */
    @Override
    public FSubject setOwner(final String owner) {
        this.owner = owner;
        return this;
    }
     ...
     */
    @Override
    public FSubject setCompanyId(final String companyId) {
        this.companyId = companyId;
        return this;
    }
     ...
     */
    @Override
    public FSubject setParentId(final String parentId) {
        this.parentId = parentId;
        return this;
    }
     ...
     */
    @Override
    public FSubject setSigma(final String sigma) {
        this.sigma = sigma;
        return this;
    }
     ...
     */
    @Override
    public FSubject setLanguage(final String language) {
        this.language = language;
        return this;
    }
     ...
     */
    @Override
    public FSubject setActive(final Boolean active) {
        this.active = active;
        return this;
    }
     ...
     */
    @Override
    public FSubject setMetadata(final String metadata) {
        this.metadata = metadata;
        return this;
    }
     ...
     */
    @Override
    public FSubject setCreatedAt(final LocalDateTime createdAt) {
        this.createdAt = createdAt;
        return this;
    }
     ...
     */
    @Override
    public FSubject setCreatedBy(final String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     */
    @Override
    public FSubject setUpdatedAt(final LocalDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
     ...
     */
    @Override
    public FSubject setUpdatedBy(final String updatedBy) {
        this.updatedBy = updatedBy;
        return this;
    }
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("FSubject (");
