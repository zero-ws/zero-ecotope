...
public class FTransRecord extends UpdatableRecordImpl<FTransRecord> implements VertxPojo, IFTrans {
     ...
     */
    public FTransRecord(String key, String name, String code, String serial, String type, String status, BigDecimal amount, BigDecimal amountPre, BigDecimal amountGap, String rounded, Boolean prepay, String comment, LocalDateTime startAt, LocalDateTime endAt, String groupBy, String sigma, String language, Boolean active, String metadata, LocalDateTime createdAt, String createdBy, LocalDateTime updatedAt, String updatedBy, String appId, String tenantId) {
        super(FTrans.F_TRANS);
    ...
    /**
     * Getter for <code>ZDB.F_TRANS.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.F_TRANS.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    @Override
