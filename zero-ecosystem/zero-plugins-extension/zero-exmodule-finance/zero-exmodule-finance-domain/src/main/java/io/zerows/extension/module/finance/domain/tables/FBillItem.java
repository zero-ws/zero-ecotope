...
public class FBillItem extends TableImpl<FBillItemRecord> {
    ...
    /**
     * The column <code>ZDB.F_BILL_ITEM.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    public final TableField<FBillItemRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 用户组绑定的统一标识");
     ...
     */
    public final TableField<FBillItemRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
