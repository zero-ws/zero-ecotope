 ...
 */
public class DataTran implements Serializable, HJson {
    ...
    public static DataTran instance() {
        return new DataTran();
    }

    public DataTran of(final List<FTransOf> ofs) {
        this.transOf.clear();
        this.transOf.addAll(ofs);
        return this;
    }

    public DataTran items(final List<FTransItem> items) {
        this.items.clear();
    ...
    public boolean equals(final Object o) {
        ...
        final DataTran tranData = (DataTran) o;
