...
public class FSettlement implements VertxPojo, IFSettlement {
    ...
    public FSettlement(final IFSettlement value) {
    ...
    public FSettlement(final io.vertx.core.json.JsonObject json) {
        this();
        fromJson(json);
    }
     ...
     */
    @Override
    public FSettlement setKey(final String key) {
        this.key = key;
        return this;
    }
     ...
     */
    @Override
    public FSettlement setCode(final String code) {
        this.code = code;
        return this;
    }
     ...
     */
    @Override
    public FSettlement setSerial(final String serial) {
        this.serial = serial;
        return this;
    }
     ...
     */
    @Override
    public FSettlement setAmount(final BigDecimal amount) {
        this.amount = amount;
        return this;
    }
     ...
     */
    @Override
    public FSettlement setComment(final String comment) {
        this.comment = comment;
        return this;
    }
     ...
     */
    @Override
    public FSettlement setFinished(final Boolean finished) {
        this.finished = finished;
        return this;
    }
     ...
     */
    @Override
    public FSettlement setFinishedAt(final LocalDateTime finishedAt) {
        this.finishedAt = finishedAt;
        return this;
    }
     ...
     */
    @Override
    public FSettlement setSignName(final String signName) {
        this.signName = signName;
        return this;
    }
     ...
     */
    @Override
    public FSettlement setSignMobile(final String signMobile) {
        this.signMobile = signMobile;
        return this;
    }
     ...
     */
    @Override
    public FSettlement setStartAt(final LocalDateTime startAt) {
        this.startAt = startAt;
        return this;
    }
     ...
     */
    @Override
    public FSettlement setEndAt(final LocalDateTime endAt) {
        this.endAt = endAt;
        return this;
    }
     ...
     */
    @Override
    public FSettlement setGroupBy(final String groupBy) {
        this.groupBy = groupBy;
        return this;
    }
     ...
     */
    @Override
    public FSettlement setCustomerId(final String customerId) {
        this.customerId = customerId;
        return this;
    }
     ...
     */
    @Override
    public FSettlement setRelatedId(final String relatedId) {
        this.relatedId = relatedId;
        return this;
    }
     ...
     */
    @Override
    public FSettlement setSigma(final String sigma) {
        this.sigma = sigma;
        return this;
    }
     ...
     */
    @Override
    public FSettlement setLanguage(final String language) {
        this.language = language;
        return this;
    }
     ...
     */
    @Override
    public FSettlement setActive(final Boolean active) {
        this.active = active;
        return this;
    }
     ...
     */
    @Override
    public FSettlement setMetadata(final String metadata) {
        this.metadata = metadata;
        return this;
    }
     ...
     */
    @Override
    public FSettlement setCreatedAt(final LocalDateTime createdAt) {
        this.createdAt = createdAt;
        return this;
    }
     ...
     */
    @Override
    public FSettlement setCreatedBy(final String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     */
    @Override
    public FSettlement setUpdatedAt(final LocalDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
     ...
     */
    @Override
    public FSettlement setUpdatedBy(final String updatedBy) {
        this.updatedBy = updatedBy;
        return this;
    }
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("FSettlement (");
