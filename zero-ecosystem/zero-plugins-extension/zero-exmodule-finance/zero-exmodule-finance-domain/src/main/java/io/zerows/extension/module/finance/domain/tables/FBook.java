...
public class FBook extends TableImpl<FBookRecord> {
    ...
    /**
     * The column <code>ZDB.F_BOOK.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    public final TableField<FBookRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 用户组绑定的统一标识");
    /**
     ...
     */
    public final TableField<FBookRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
    /**
