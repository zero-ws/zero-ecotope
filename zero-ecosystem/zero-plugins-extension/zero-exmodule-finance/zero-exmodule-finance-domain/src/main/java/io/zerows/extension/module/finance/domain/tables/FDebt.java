...
public class FDebt extends TableImpl<FDebtRecord> {
    ...
    /**
     * The column <code>ZDB.F_DEBT.ID</code>. 「id」- 主键
     */
    public final TableField<FDebtRecord, String> ID = createField(DSL.name("ID"), SQLDataType.VARCHAR(36).nullable(false), this, "「id」- 主键");
    ...
    /**
     * The column <code>ZDB.F_DEBT.CODE</code>. 「code」- 编号
     */
    public final TableField<FDebtRecord, String> CODE = createField(DSL.name("CODE"), SQLDataType.VARCHAR(255).nullable(false), this, "「code」- 编号");
    ...
    /**
     * The column <code>ZDB.F_DEBT.NAME</code>. 「name」- 名称
     */
    public final TableField<FDebtRecord, String> NAME = createField(DSL.name("NAME"), SQLDataType.VARCHAR(255), this, "「name」- 名称");

    /**
     * The column <code>ZDB.F_DEBT.SERIAL</code>. 「serial」- 单号
     */
    public final TableField<FDebtRecord, String> SERIAL = createField(DSL.name("SERIAL"), SQLDataType.VARCHAR(36).nullable(false), this, "「serial」- 单号");
     ...
     */
    public final TableField<FDebtRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 统一标识");
    ...
    /**
     * The column <code>ZDB.F_DEBT.LANGUAGE</code>. 「language」- 语言偏好
     */
    public final TableField<FDebtRecord, String> LANGUAGE = createField(DSL.name("LANGUAGE"), SQLDataType.VARCHAR(10), this, "「language」- 语言偏好");
     ...
     */
    public final TableField<FDebtRecord, String> VERSION = createField(DSL.name("VERSION"), SQLDataType.VARCHAR(64), this, "「version」- 版本号");
    ...
    private FDebt(Name alias, Table<FDebtRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment("F_DEBT"), TableOptions.table(), where);
    }
    ...
    public List<UniqueKey<FDebtRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_F_DEBT_UK_F_DEBT_CODE_SIGMA, Keys.KEY_F_DEBT_UK_F_DEBT_SERIAL_SIGMA);
    }
