...
public class FPayTerm extends TableImpl<FPayTermRecord> {
    ...
    /**
     * The column <code>ZDB.F_PAY_TERM.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    public final TableField<FPayTermRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 用户组绑定的统一标识");
     ...
     */
    public final TableField<FPayTermRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
    ...
    public List<UniqueKey<FPayTermRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_F_PAY_TERM_CODE, Keys.KEY_F_PAY_TERM_NAME);
    }
