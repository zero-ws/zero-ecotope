...
public class FSettlementItem extends TableImpl<FSettlementItemRecord> {
    ...
    /**
     * The column <code>ZDB.F_SETTLEMENT_ITEM.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    public final TableField<FSettlementItemRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 用户组绑定的统一标识");
     ...
     * 附加配置数据
     */
    public final TableField<FSettlementItemRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
