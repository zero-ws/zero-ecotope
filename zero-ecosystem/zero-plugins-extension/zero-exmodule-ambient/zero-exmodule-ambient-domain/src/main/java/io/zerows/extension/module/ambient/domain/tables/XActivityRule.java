...
public class XActivityRule extends TableImpl<XActivityRuleRecord> {
     ...
     * 参数模板专用，JsonObject结构
     */
    public final TableField<XActivityRuleRecord, String> RULE_TPL = createField(DSL.name("RULE_TPL"), SQLDataType.CLOB(65535), this, "「ruleTpl」- 参数模板专用，JsonObject结构");
     ...
     */
    public final TableField<XActivityRuleRecord, String> RULE_MESSAGE = createField(DSL.name("RULE_MESSAGE"), SQLDataType.CLOB(65535), this, "「ruleMessage」- 输出消息专用, Ut.fromExpression解析（特殊解析）");
    ...
    /**
     * The column <code>ZDB.X_ACTIVITY_RULE.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    public final TableField<XActivityRuleRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 用户组绑定的统一标识");

    /**
     * The column <code>ZDB.X_ACTIVITY_RULE.LANGUAGE</code>. 「language」- 使用的语言
     */
    public final TableField<XActivityRuleRecord, String> LANGUAGE = createField(DSL.name("LANGUAGE"), SQLDataType.VARCHAR(10), this, "「language」- 使用的语言");
    ...
    /**
     * The column <code>ZDB.X_ACTIVITY_RULE.METADATA</code>. 「metadata」- 附加配置数据
     */
    public final TableField<XActivityRuleRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
