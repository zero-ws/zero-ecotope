...
public class XLog implements VertxPojo, IXLog {
    ...
    public XLog(
        ...
        final String type,
        final String level,
        final String infoStack,
        final String infoSystem,
        final String infoReadable,
        final LocalDateTime infoAt,
        final String logAgent,
        final String logIp,
    ...
    public XLog(final io.vertx.core.json.JsonObject json) {
        this();
        fromJson(json);
    }
     ...
     */
    @Override
    public XLog setKey(final String key) {
        this.key = key;
        return this;
    }
     ...
     */
    @Override
    public XLog setType(final String type) {
        this.type = type;
        return this;
    }
     ...
     */
    @Override
    public XLog setLevel(final String level) {
        this.level = level;
        return this;
    }
     ...
     */
    @Override
    public XLog setInfoStack(final String infoStack) {
        this.infoStack = infoStack;
        return this;
    }
     ...
     */
    @Override
    public XLog setInfoSystem(final String infoSystem) {
        this.infoSystem = infoSystem;
        return this;
    }
     ...
     */
    @Override
    public XLog setInfoReadable(final String infoReadable) {
        this.infoReadable = infoReadable;
        return this;
    }
     ...
     */
    @Override
    public XLog setInfoAt(final LocalDateTime infoAt) {
        this.infoAt = infoAt;
        return this;
    }
     ...
     */
    @Override
    public XLog setLogAgent(final String logAgent) {
        this.logAgent = logAgent;
        return this;
    }
     ...
     */
    @Override
    public XLog setLogIp(final String logIp) {
        this.logIp = logIp;
        return this;
    }
     ...
     */
    @Override
    public XLog setLogUser(final String logUser) {
        this.logUser = logUser;
        return this;
    }
     ...
     */
    @Override
    public XLog setActive(final Boolean active) {
        this.active = active;
        return this;
    }
     ...
     */
    @Override
    public XLog setSigma(final String sigma) {
        this.sigma = sigma;
        return this;
    }
     ...
     */
    @Override
    public XLog setMetadata(final String metadata) {
        this.metadata = metadata;
        return this;
    }
     ...
     */
    @Override
    public XLog setLanguage(final String language) {
        this.language = language;
        return this;
    }
     ...
     */
    @Override
    public XLog setCreatedAt(final LocalDateTime createdAt) {
        this.createdAt = createdAt;
        return this;
    }
     ...
     */
    @Override
    public XLog setCreatedBy(final String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     */
    @Override
    public XLog setUpdatedAt(final LocalDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
     ...
     */
    @Override
    public XLog setUpdatedBy(final String updatedBy) {
        this.updatedBy = updatedBy;
        return this;
    }
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("XLog (");
