...
public class XAttachmentRecord extends UpdatableRecordImpl<XAttachmentRecord> implements VertxPojo, IXAttachment {
    ...
    /**
     * Setter for <code>ZDB.X_ATTACHMENT.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.X_ATTACHMENT.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.X_ATTACHMENT.METADATA</code>. 「metadata」- 附加配置数据
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.X_ATTACHMENT.METADATA</code>. 「metadata」- 附加配置数据
     */
    @Override
