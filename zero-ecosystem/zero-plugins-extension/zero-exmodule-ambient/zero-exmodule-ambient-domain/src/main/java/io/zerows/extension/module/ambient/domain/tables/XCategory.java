...
public class XCategory extends TableImpl<XCategoryRecord> {
     ...
     */
    public final TableField<XCategoryRecord, String> COMMENT = createField(DSL.name("COMMENT"), SQLDataType.CLOB(65535), this, "「comment」- 备注信息");
    /**
     * The column <code>ZDB.X_CATEGORY.TREE_COMPONENT</code>. 「treeComponent」-
     * 目录组件，构造树专用
     */
    public final TableField<XCategoryRecord, String> TREE_COMPONENT = createField(DSL.name("TREE_COMPONENT"), SQLDataType.CLOB(65535), this, "「treeComponent」- 目录组件，构造树专用");
    /**
    ...
    /**
     * The column <code>ZDB.X_CATEGORY.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    public final TableField<XCategoryRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 用户组绑定的统一标识");
    /**
     * The column <code>ZDB.X_CATEGORY.LANGUAGE</code>. 「language」- 使用的语言
     */
    public final TableField<XCategoryRecord, String> LANGUAGE = createField(DSL.name("LANGUAGE"), SQLDataType.VARCHAR(10), this, "「language」- 使用的语言");
    /**
    ...
    /**
     * The column <code>ZDB.X_CATEGORY.METADATA</code>. 「metadata」- 附加配置数据
     */
    public final TableField<XCategoryRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
    /**
