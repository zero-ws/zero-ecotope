...
public class XActivityChange implements VertxPojo, IXActivityChange {
    ...
    public XActivityChange(final IXActivityChange value) {
    ...
    public XActivityChange(final io.vertx.core.json.JsonObject json) {
        this();
        fromJson(json);
    }
     ...
     */
    @Override
    public XActivityChange setKey(final String key) {
        this.key = key;
        return this;
    }
     ...
     */
    @Override
    public XActivityChange setActivityId(final String activityId) {
        this.activityId = activityId;
        return this;
    }
     ...
     */
    @Override
    public XActivityChange setType(final String type) {
        this.type = type;
        return this;
    }
     ...
     */
    @Override
    public XActivityChange setStatus(final String status) {
        this.status = status;
        return this;
    }
     ...
     */
    @Override
    public XActivityChange setFieldName(final String fieldName) {
        this.fieldName = fieldName;
        return this;
    }
     ...
     */
    @Override
    public XActivityChange setFieldAlias(final String fieldAlias) {
        this.fieldAlias = fieldAlias;
        return this;
    }
     ...
     */
    @Override
    public XActivityChange setFieldType(final String fieldType) {
        this.fieldType = fieldType;
        return this;
    }
     ...
     */
    @Override
    public XActivityChange setValueOld(final String valueOld) {
        this.valueOld = valueOld;
        return this;
    }
     ...
     */
    @Override
    public XActivityChange setValueNew(final String valueNew) {
        this.valueNew = valueNew;
        return this;
    }
     ...
     */
    @Override
    public XActivityChange setSigma(final String sigma) {
        this.sigma = sigma;
        return this;
    }
     ...
     */
    @Override
    public XActivityChange setLanguage(final String language) {
        this.language = language;
        return this;
    }
     ...
     */
    @Override
    public XActivityChange setActive(final Boolean active) {
        this.active = active;
        return this;
    }
     ...
     */
    @Override
    public XActivityChange setMetadata(final String metadata) {
        this.metadata = metadata;
        return this;
    }
     ...
     */
    @Override
    public XActivityChange setCreatedAt(final LocalDateTime createdAt) {
        this.createdAt = createdAt;
        return this;
    }
     ...
     */
    @Override
    public XActivityChange setCreatedBy(final String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     */
    @Override
    public XActivityChange setUpdatedAt(final LocalDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
     ...
     */
    @Override
    public XActivityChange setUpdatedBy(final String updatedBy) {
        this.updatedBy = updatedBy;
        return this;
    }
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("XActivityChange (");
