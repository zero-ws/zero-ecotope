...
public class XLinkage extends TableImpl<XLinkageRecord> {
     ...
     * source / ofMain 计算
     */
    public final TableField<XLinkageRecord, String> LINK_KEY = createField(DSL.name("LINK_KEY"), SQLDataType.VARCHAR(255), this, "「linkKey」- 双向Key计算，根据 source / ofMain 计算");
    /**
    ...
    /**
     * The column <code>ZDB.X_LINKAGE.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    public final TableField<XLinkageRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 用户组绑定的统一标识");
    /**
     ...
     */
    public final TableField<XLinkageRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
    /**
    ...
    public List<UniqueKey<XLinkageRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_X_LINKAGE_LINK_KEY, Keys.KEY_X_LINKAGE_REGION);
    }
