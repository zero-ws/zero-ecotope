...
public class XSource extends TableImpl<XSourceRecord> {
     ...
     */
    public final TableField<XSourceRecord, String> JDBC_CONFIG = createField(DSL.name("JDBC_CONFIG"), SQLDataType.CLOB(65535), this, "「jdbcConfig」- 连接字符串中的配置key=findRunning");
    /**
    ...
    /**
     * The column <code>ZDB.X_SOURCE.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    public final TableField<XSourceRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 用户组绑定的统一标识");
    /**
     * The column <code>ZDB.X_SOURCE.LANGUAGE</code>. 「language」- 使用的语言
     */
    public final TableField<XSourceRecord, String> LANGUAGE = createField(DSL.name("LANGUAGE"), SQLDataType.VARCHAR(10), this, "「language」- 使用的语言");
    /**
    ...
    /**
     * The column <code>ZDB.X_SOURCE.METADATA</code>. 「metadata」- 附加配置数据
     */
    public final TableField<XSourceRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
    /**
