...
public class XApp extends TableImpl<XAppRecord> {
    ...
    /**
     * The column <code>ZDB.X_APP.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    public final TableField<XAppRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 用户组绑定的统一标识");
    /**
     * The column <code>ZDB.X_APP.LANGUAGE</code>. 「language」- 使用的语言
     */
    public final TableField<XAppRecord, String> LANGUAGE = createField(DSL.name("LANGUAGE"), SQLDataType.VARCHAR(10), this, "「language」- 使用的语言");
    /**
    ...
    /**
     * The column <code>ZDB.X_APP.METADATA</code>. 「metadata」- 附加配置数据
     */
    public final TableField<XAppRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
    /**
    ...
    /**
     * The column <code>ZDB.X_APP.APP_ID</code>. 「appId」- 应用ID
     */
    public final TableField<XAppRecord, String> APP_ID = createField(DSL.name("APP_ID"), SQLDataType.VARCHAR(36), this, "「appId」- 应用ID");
    /**
    ...
    public List<UniqueKey<XAppRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_X_APP_CODE, Keys.KEY_X_APP_CONTEXT, Keys.KEY_X_APP_CONTEXT_2, Keys.KEY_X_APP_NAME);
    }
