...
public class XAppRecord extends UpdatableRecordImpl<XAppRecord> implements VertxPojo, IXApp {
     ...
     */
    public XAppRecord(String key, String name, String code, String status, String appSecret, String appKey, String title, String logo, String icp, String copyRight, String email, String domain, Integer port, String context, String urlLogin, String urlAdmin, String endpoint, String entry, String sigma, String language, Boolean active, String metadata, LocalDateTime createdAt, String createdBy, LocalDateTime updatedAt, String updatedBy, String appId, String tenantId) {
        super(XApp.X_APP);
