...
public class XActivity extends TableImpl<XActivityRecord> {
     ...
     */
    public final TableField<XActivityRecord, String> DESCRIPTION = createField(DSL.name("DESCRIPTION"), SQLDataType.CLOB(65535), this, "「description」- 操作描述信息");
     ...
     */
    public final TableField<XActivityRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
