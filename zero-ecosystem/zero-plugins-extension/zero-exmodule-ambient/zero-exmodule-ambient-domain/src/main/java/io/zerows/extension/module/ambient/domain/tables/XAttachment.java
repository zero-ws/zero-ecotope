...
public class XAttachment extends TableImpl<XAttachmentRecord> {
    ...
    /**
     * The column <code>ZDB.X_ATTACHMENT.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    public final TableField<XAttachmentRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 用户组绑定的统一标识");

    /**
     * The column <code>ZDB.X_ATTACHMENT.LANGUAGE</code>. 「language」- 使用的语言
     */
    public final TableField<XAttachmentRecord, String> LANGUAGE = createField(DSL.name("LANGUAGE"), SQLDataType.VARCHAR(10), this, "「language」- 使用的语言");
    ...
    /**
     * The column <code>ZDB.X_ATTACHMENT.METADATA</code>. 「metadata」- 附加配置数据
     */
    public final TableField<XAttachmentRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
    ...
    public List<UniqueKey<XAttachmentRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_X_ATTACHMENT_FILE_KEY, Keys.KEY_X_ATTACHMENT_FILE_PATH, Keys.KEY_X_ATTACHMENT_FILE_URL);
    }
