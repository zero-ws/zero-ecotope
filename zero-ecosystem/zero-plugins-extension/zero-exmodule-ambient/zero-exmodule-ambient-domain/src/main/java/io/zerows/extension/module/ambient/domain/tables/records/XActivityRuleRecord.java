...
public class XActivityRuleRecord extends UpdatableRecordImpl<XActivityRuleRecord> implements VertxPojo, IXActivityRule {
    ...
    /**
     * Getter for <code>ZDB.X_ACTIVITY_RULE.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.X_ACTIVITY_RULE.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.X_ACTIVITY_RULE.METADATA</code>. 「metadata」- 附加配置数据
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.X_ACTIVITY_RULE.METADATA</code>. 「metadata」- 附加配置数据
     */
    @Override
