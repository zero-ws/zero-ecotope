...
CREATE TABLE IF NOT EXISTS `X_NOTICE` (
    ...
    `CONTENT`     LONGTEXT      COLLATE utf8mb4_bin COMMENT '「content」- 公告内容',
    ...
    UNIQUE KEY `UK_X_NOTICE_APP_ID_CODE` (`APP_ID`, `CODE`) USING BTREE,
    UNIQUE KEY `UK_X_NOTICE_APP_ID_NAME` (`APP_ID`, `NAME`) USING BTREE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_bin COMMENT='X_NOTICE';
