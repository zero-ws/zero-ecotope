...
public class IDirectory extends TableImpl<IDirectoryRecord> {
    ...
    /**
     * The column <code>ZDB.I_DIRECTORY.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    public final TableField<IDirectoryRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 用户组绑定的统一标识");
    /**
     ...
     */
    public final TableField<IDirectoryRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
    /**
    ...
    public List<UniqueKey<IDirectoryRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_I_DIRECTORY_CODE, Keys.KEY_I_DIRECTORY_NAME, Keys.KEY_I_DIRECTORY_STORE_PATH);
    }
