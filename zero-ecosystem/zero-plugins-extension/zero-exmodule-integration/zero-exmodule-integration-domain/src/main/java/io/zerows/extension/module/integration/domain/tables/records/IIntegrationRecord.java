...
public class IIntegrationRecord extends UpdatableRecordImpl<IIntegrationRecord> implements VertxPojo, IIIntegration {
    ...
    /**
     * Getter for <code>ZDB.I_INTEGRATION.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.I_INTEGRATION.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.I_INTEGRATION.METADATA</code>. 「metadata」- 附加配置数据
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.I_INTEGRATION.METADATA</code>. 「metadata」- 附加配置数据
     */
    @Override
