...
public class IPortfolio extends TableImpl<IPortfolioRecord> {
     ...
     * 执行组件，LDAP执行专用
     */
    public final TableField<IPortfolioRecord, String> RUN_COMPONENT = createField(DSL.name("RUN_COMPONENT"), SQLDataType.CLOB(65535), this, "「runComponent」- 执行组件，LDAP执行专用");
    ...
    /**
     * The column <code>ZDB.I_PORTFOLIO.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    public final TableField<IPortfolioRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 用户组绑定的统一标识");

    /**
     * The column <code>ZDB.I_PORTFOLIO.LANGUAGE</code>. 「language」- 使用的语言
     */
    public final TableField<IPortfolioRecord, String> LANGUAGE = createField(DSL.name("LANGUAGE"), SQLDataType.VARCHAR(10), this, "「language」- 使用的语言");
    ...
    /**
     * The column <code>ZDB.I_PORTFOLIO.METADATA</code>. 「metadata」- 附加配置数据
     */
    public final TableField<IPortfolioRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
