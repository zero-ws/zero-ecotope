...
public interface Combiner<I, M> {
    ...
    static Combiner<JsonObject, Collection<BBag>> outChildren() {
        ...
        // return RFn.po?lThread(Pool.COMBINER, CombinerOutChildren::new, CombinerOutChildren.class.getName());
    }
