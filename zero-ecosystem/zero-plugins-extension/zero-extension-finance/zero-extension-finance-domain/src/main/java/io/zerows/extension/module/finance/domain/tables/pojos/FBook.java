...
public class FBook implements VertxPojo, IFBook {
    ...
    public FBook(final IFBook value) {
    ...
    public FBook(
        ...
        final String checkedDesc,
        final Boolean exceed,
        final String exceedDesc,
    ...
    public FBook(final io.vertx.core.json.JsonObject json) {
        this();
        fromJson(json);
    }
     ...
     */
    @Override
    public FBook setKey(final String key) {
        this.key = key;
        return this;
    }
     ...
     */
    @Override
    public FBook setName(final String name) {
        this.name = name;
        return this;
    }
     ...
     */
    @Override
    public FBook setCode(final String code) {
        this.code = code;
        return this;
    }
     ...
     */
    @Override
    public FBook setSerial(final String serial) {
        this.serial = serial;
        return this;
    }
     ...
     */
    @Override
    public FBook setType(final String type) {
        this.type = type;
        return this;
    }
     ...
     */
    @Override
    public FBook setStatus(final String status) {
        this.status = status;
        return this;
    }
     ...
     */
    @Override
    public FBook setMajor(final Boolean major) {
        this.major = major;
        return this;
    }
     ...
     */
    @Override
    public FBook setAmount(final BigDecimal amount) {
        this.amount = amount;
        return this;
    }
     ...
     */
    @Override
    public FBook setComment(final String comment) {
        this.comment = comment;
        return this;
    }
     ...
     */
    @Override
    public FBook setChecked(final Boolean checked) {
        this.checked = checked;
        return this;
    }
     ...
     */
    @Override
    public FBook setCheckedDesc(final String checkedDesc) {
        this.checkedDesc = checkedDesc;
        return this;
    }
     ...
     */
    @Override
    public FBook setExceed(final Boolean exceed) {
        this.exceed = exceed;
        return this;
    }
     ...
     */
    @Override
    public FBook setExceedDesc(final String exceedDesc) {
        this.exceedDesc = exceedDesc;
        return this;
    }
     ...
     */
    @Override
    public FBook setModelId(final String modelId) {
        this.modelId = modelId;
        return this;
    }
     ...
     */
    @Override
    public FBook setModelKey(final String modelKey) {
        this.modelKey = modelKey;
        return this;
    }
     ...
     */
    @Override
    public FBook setParentId(final String parentId) {
        this.parentId = parentId;
        return this;
    }
     ...
     */
    @Override
    public FBook setOrderId(final String orderId) {
        this.orderId = orderId;
        return this;
    }
     ...
     */
    @Override
    public FBook setSigma(final String sigma) {
        this.sigma = sigma;
        return this;
    }
     ...
     */
    @Override
    public FBook setLanguage(final String language) {
        this.language = language;
        return this;
    }
     ...
     */
    @Override
    public FBook setActive(final Boolean active) {
        this.active = active;
        return this;
    }
     ...
     */
    @Override
    public FBook setMetadata(final String metadata) {
        this.metadata = metadata;
        return this;
    }
     ...
     */
    @Override
    public FBook setCreatedAt(final LocalDateTime createdAt) {
        this.createdAt = createdAt;
        return this;
    }
     ...
     */
    @Override
    public FBook setCreatedBy(final String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     */
    @Override
    public FBook setUpdatedAt(final LocalDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
     ...
     */
    @Override
    public FBook setUpdatedBy(final String updatedBy) {
        this.updatedBy = updatedBy;
        return this;
    }
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("FBook (");
    ...
    @Override
    public void from(final IFBook from) {
        setKey(from.getKey());
    ...
    @Override
    public <E extends IFBook> E into(final E into) {
        into.from(this);
        return into;
    }
}
