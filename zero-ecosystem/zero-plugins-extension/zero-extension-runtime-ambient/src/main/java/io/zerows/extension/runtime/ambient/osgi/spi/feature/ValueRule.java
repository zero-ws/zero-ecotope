...
import io.zerows.epoch.component.expression.wffs.Formula;
import io.zerows.epoch.component.expression.wffs.Regulation;
...
public class ValueRule implements Valve {
    ...
    private String ruleIndent(final XActivityRule rule) {
        ...
        if (Ut.isNil(code)) {
            throw new _80305Exception500IndentMissing(initData.encode());
        }
        return code;
    }
