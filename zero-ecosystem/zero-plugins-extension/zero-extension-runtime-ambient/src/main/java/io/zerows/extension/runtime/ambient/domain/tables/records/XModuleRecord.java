...
import io.zerows.extension.runtime.ambient.domain.tables.interfaces.IXModule;
...
public class XModuleRecord extends UpdatableRecordImpl<XModuleRecord> implements VertxPojo, Record15<String, String, String, String, String, String, String, Boolean, String, String, String, LocalDateTime, String, LocalDateTime, String>, IXModule {
     ...
     * Create a detached, initialised XModuleRecord
     */
    public XModuleRecord(final io.zerows.extension.runtime.ambient.domain.tables.pojos.XModule value) {
        super(XModule.X_MODULE);
