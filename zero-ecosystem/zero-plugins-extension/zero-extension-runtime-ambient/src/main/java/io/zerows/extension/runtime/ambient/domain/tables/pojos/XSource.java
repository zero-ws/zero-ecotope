...
public class XSource implements VertxPojo, IXSource {
    ...
    public XSource(final IXSource value) {
    ...
    public XSource(final io.vertx.core.json.JsonObject json) {
        this();
        fromJson(json);
    }
     ...
     */
    @Override
    public XSource setKey(final String key) {
        this.key = key;
        return this;
    }
     ...
     */
    @Override
    public XSource setIpV4(final String ipV4) {
        this.ipV4 = ipV4;
        return this;
    }
     ...
     */
    @Override
    public XSource setIpV6(final String ipV6) {
        this.ipV6 = ipV6;
        return this;
    }
     ...
     */
    @Override
    public XSource setHostname(final String hostname) {
        this.hostname = hostname;
        return this;
    }
     ...
     */
    @Override
    public XSource setPort(final Integer port) {
        this.port = port;
        return this;
    }
     ...
     */
    @Override
    public XSource setCategory(final String category) {
        this.category = category;
        return this;
    }
     ...
     */
    @Override
    public XSource setDriverClassName(final String driverClassName) {
        this.driverClassName = driverClassName;
        return this;
    }
     ...
     */
    @Override
    public XSource setJdbcUrl(final String jdbcUrl) {
        this.jdbcUrl = jdbcUrl;
        return this;
    }
     ...
     */
    @Override
    public XSource setJdbcConfig(final String jdbcConfig) {
        this.jdbcConfig = jdbcConfig;
        return this;
    }
     ...
     */
    @Override
    public XSource setInstance(final String instance) {
        this.instance = instance;
        return this;
    }
     ...
     */
    @Override
    public XSource setUsername(final String username) {
        this.username = username;
        return this;
    }
     ...
     */
    @Override
    public XSource setPassword(final String password) {
        this.password = password;
        return this;
    }
     ...
     */
    @Override
    public XSource setAppId(final String appId) {
        this.appId = appId;
        return this;
    }
     ...
     */
    @Override
    public XSource setActive(final Boolean active) {
        this.active = active;
        return this;
    }
     ...
     */
    @Override
    public XSource setSigma(final String sigma) {
        this.sigma = sigma;
        return this;
    }
     ...
     */
    @Override
    public XSource setMetadata(final String metadata) {
        this.metadata = metadata;
        return this;
    }
     ...
     */
    @Override
    public XSource setLanguage(final String language) {
        this.language = language;
        return this;
    }
     ...
     */
    @Override
    public XSource setCreatedAt(final LocalDateTime createdAt) {
        this.createdAt = createdAt;
        return this;
    }
     ...
     */
    @Override
    public XSource setCreatedBy(final String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     */
    @Override
    public XSource setUpdatedAt(final LocalDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
     ...
     */
    @Override
    public XSource setUpdatedBy(final String updatedBy) {
        this.updatedBy = updatedBy;
        return this;
    }
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("XSource (");
