...
public class RRolePermDao extends AbstractVertxDAO<RRolePermRecord, io.zerows.extension.commerce.rbac.domain.tables.pojos.RRolePerm, Record2<String, String>, Future<List<io.zerows.extension.commerce.rbac.domain.tables.pojos.RRolePerm>>, Future<io.zerows.extension.commerce.rbac.domain.tables.pojos.RRolePerm>, Future<Integer>, Future<Record2<String, String>>> implements io.r2mo.vertx.jooq.classic.VertxDAO<RRolePermRecord, io.zerows.extension.commerce.rbac.domain.tables.pojos.RRolePerm, Record2<String, String>> {
    ...
    @Override
    protected Record2<String, String> getId(final io.zerows.extension.commerce.rbac.domain.tables.pojos.RRolePerm object) {
     ...
     */
    public Future<List<io.zerows.extension.commerce.rbac.domain.tables.pojos.RRolePerm>> findManyByRoleId(final Collection<String> values) {
     ...
     */
    public Future<List<io.zerows.extension.commerce.rbac.domain.tables.pojos.RRolePerm>> findManyByRoleId(final Collection<String> values, final int limit) {
