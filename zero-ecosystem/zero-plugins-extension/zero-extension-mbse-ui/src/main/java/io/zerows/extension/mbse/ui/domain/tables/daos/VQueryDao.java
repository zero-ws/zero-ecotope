...
public class VQueryDao extends AbstractVertxDAO<VQueryRecord, io.zerows.extension.mbse.ui.domain.tables.pojos.VQuery, String, Future<List<io.zerows.extension.mbse.ui.domain.tables.pojos.VQuery>>, Future<io.zerows.extension.mbse.ui.domain.tables.pojos.VQuery>, Future<Integer>, Future<String>> implements io.github.jklingsporn.vertx.jooq.classic.VertxDAO<VQueryRecord, io.zerows.extension.mbse.ui.domain.tables.pojos.VQuery, String> {
    ...
    @Override
    protected String getId(io.zerows.extension.mbse.ui.domain.tables.pojos.VQuery object) {
     ...
     */
    public Future<List<io.zerows.extension.mbse.ui.domain.tables.pojos.VQuery>> findManyByProjection(Collection<String> values) {
     ...
     */
    public Future<List<io.zerows.extension.mbse.ui.domain.tables.pojos.VQuery>> findManyByProjection(Collection<String> values, int limit) {
     ...
     */
    public Future<List<io.zerows.extension.mbse.ui.domain.tables.pojos.VQuery>> findManyByPager(Collection<String> values) {
     ...
     * limited by the given limit
     */
    public Future<List<io.zerows.extension.mbse.ui.domain.tables.pojos.VQuery>> findManyByPager(Collection<String> values, int limit) {
     ...
     */
    public Future<List<io.zerows.extension.mbse.ui.domain.tables.pojos.VQuery>> findManyBySorter(Collection<String> values) {
     ...
     * limited by the given limit
     */
    public Future<List<io.zerows.extension.mbse.ui.domain.tables.pojos.VQuery>> findManyBySorter(Collection<String> values, int limit) {
     ...
     */
    public Future<List<io.zerows.extension.mbse.ui.domain.tables.pojos.VQuery>> findManyByCriteria(Collection<String> values) {
     ...
     * limited by the given limit
     */
    public Future<List<io.zerows.extension.mbse.ui.domain.tables.pojos.VQuery>> findManyByCriteria(Collection<String> values, int limit) {
