...
public class ECompanyRecord extends UpdatableRecordImpl<ECompanyRecord> implements VertxPojo, IECompany {
    ...
    /**
     * Setter for <code>ZDB.E_COMPANY.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.E_COMPANY.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.E_COMPANY.METADATA</code>. 「metadata」- 附加配置数据
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.E_COMPANY.METADATA</code>. 「metadata」- 附加配置数据
     */
    @Override
