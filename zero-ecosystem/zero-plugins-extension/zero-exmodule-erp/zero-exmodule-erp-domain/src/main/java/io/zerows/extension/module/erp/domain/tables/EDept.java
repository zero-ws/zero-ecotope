...
public class EDept extends TableImpl<EDeptRecord> {
    ...
    /**
     * The column <code>ZDB.E_DEPT.ID</code>. 「id」- 主键
     */
    public final TableField<EDeptRecord, String> ID = createField(DSL.name("ID"), SQLDataType.VARCHAR(36).nullable(false), this, "「id」- 主键");

    /**
     * The column <code>ZDB.E_DEPT.CODE</code>. 「code」- 编号
     */
    public final TableField<EDeptRecord, String> CODE = createField(DSL.name("CODE"), SQLDataType.VARCHAR(255), this, "「code」- 编号");

    /**
     * The column <code>ZDB.E_DEPT.COMMENT</code>. 「comment」- 备注
     */
    public final TableField<EDeptRecord, String> COMMENT = createField(DSL.name("COMMENT"), SQLDataType.CLOB(65535), this, "「comment」- 备注");
    ...
    /**
     * The column <code>ZDB.E_DEPT.NAME</code>. 「name」- 名称
     */
    public final TableField<EDeptRecord, String> NAME = createField(DSL.name("NAME"), SQLDataType.VARCHAR(255), this, "「name」- 名称");

    /**
     * The column <code>ZDB.E_DEPT.SIGMA</code>. 「sigma」- 统一标识
     */
    public final TableField<EDeptRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 统一标识");
    ...
    /**
     * The column <code>ZDB.E_DEPT.LANGUAGE</code>. 「language」- 语言偏好
     */
    public final TableField<EDeptRecord, String> LANGUAGE = createField(DSL.name("LANGUAGE"), SQLDataType.VARCHAR(10), this, "「language」- 语言偏好");
     ...
     */
    public final TableField<EDeptRecord, String> VERSION = createField(DSL.name("VERSION"), SQLDataType.VARCHAR(64), this, "「version」- 版本号");
    ...
    private EDept(Name alias, Table<EDeptRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment("E_DEPT"), TableOptions.table(), where);
    }
    ...
    public List<UniqueKey<EDeptRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_E_DEPT_UK_E_DEPT_CODE_COMPANY_ID, Keys.KEY_E_DEPT_UK_E_DEPT_NAME_COMPANY_ID_DEPT_ID);
    }
