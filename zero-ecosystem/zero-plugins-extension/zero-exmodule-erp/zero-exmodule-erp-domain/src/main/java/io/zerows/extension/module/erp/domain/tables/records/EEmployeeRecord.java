...
public class EEmployeeRecord extends UpdatableRecordImpl<EEmployeeRecord> implements VertxPojo, IEEmployee {
    ...
    /**
     * Setter for <code>ZDB.E_EMPLOYEE.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.E_EMPLOYEE.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.E_EMPLOYEE.METADATA</code>. 「metadata」- 附加配置数据
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.E_EMPLOYEE.METADATA</code>. 「metadata」- 附加配置数据
     */
    @Override
     ...
     */
    public EEmployeeRecord(String key, String companyId, String deptId, String teamId, String identityId, String viceName, String viceEmail, String viceMobile, String workNumber, String workTitle, String workLocation, String workPhone, String workExtension, LocalDateTime workHireAt, String bankId, String bankCard, String type, String status, String sigma, String language, Boolean active, String metadata, LocalDateTime createdAt, String createdBy, LocalDateTime updatedAt, String updatedBy, String appId, String tenantId) {
        super(EEmployee.E_EMPLOYEE);
