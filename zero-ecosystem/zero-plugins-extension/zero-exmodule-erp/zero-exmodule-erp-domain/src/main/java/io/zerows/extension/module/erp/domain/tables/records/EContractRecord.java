...
public class EContractRecord extends UpdatableRecordImpl<EContractRecord> implements VertxPojo, IEContract {
    ...
    /**
     * Getter for <code>ZDB.E_CONTRACT.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.E_CONTRACT.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.E_CONTRACT.METADATA</code>. 「metadata」- 附加配置数据
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.E_CONTRACT.METADATA</code>. 「metadata」- 附加配置数据
     */
    @Override
