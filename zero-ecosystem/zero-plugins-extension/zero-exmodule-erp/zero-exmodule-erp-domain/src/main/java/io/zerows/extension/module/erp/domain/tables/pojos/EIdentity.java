...
public class EIdentity implements VertxPojo, IEIdentity {
     ...
     */
    @Override
    public EIdentity setId(String id) {
        this.id = id;
        return this;
    }
     ...
     */
    @Override
    public EIdentity setTenantId(String tenantId) {
        this.tenantId = tenantId;
        return this;
    }
     ...
     */
    @Override
    public EIdentity setAppId(String appId) {
        this.appId = appId;
        return this;
    }
     ...
     */
    @Override
    public EIdentity setVersion(String version) {
        this.version = version;
        return this;
    }
