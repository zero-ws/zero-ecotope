...
public class TOaVacation extends TableImpl<TOaVacationRecord> {
    ...
    /**
     * The column <code>ZDB.T_OA_VACATION.ID</code>. 「id」- 主键
     */
    public final TableField<TOaVacationRecord, String> ID = createField(DSL.name("ID"), SQLDataType.VARCHAR(36).nullable(false), this, "「id」- 主键");

    /**
     * The column <code>ZDB.T_OA_VACATION.REQUEST_BY</code>. 「requestBy」- 申请人
     */
    public final TableField<TOaVacationRecord, String> REQUEST_BY = createField(DSL.name("REQUEST_BY"), SQLDataType.VARCHAR(36), this, "「requestBy」- 申请人");

    /**
     * The column <code>ZDB.T_OA_VACATION.CLASSIFICATION</code>.
     * 「classification」- 假期类型
     */
    public final TableField<TOaVacationRecord, String> CLASSIFICATION = createField(DSL.name("CLASSIFICATION"), SQLDataType.VARCHAR(64), this, "「classification」- 假期类型");

    /**
     * The column <code>ZDB.T_OA_VACATION.REASON</code>. 「reason」- 事由
     */
    public final TableField<TOaVacationRecord, String> REASON = createField(DSL.name("REASON"), SQLDataType.CLOB, this, "「reason」- 事由");

    /**
     * The column <code>ZDB.T_OA_VACATION.WORK_CONTENT</code>. 「workContent」-
     * 工作内容
     */
    public final TableField<TOaVacationRecord, String> WORK_CONTENT = createField(DSL.name("WORK_CONTENT"), SQLDataType.CLOB, this, "「workContent」- 工作内容");

    /**
     * The column <code>ZDB.T_OA_VACATION.START_AT</code>. 「startAt」- 开始时间
     */
    public final TableField<TOaVacationRecord, LocalDateTime> START_AT = createField(DSL.name("START_AT"), SQLDataType.LOCALDATETIME(0), this, "「startAt」- 开始时间");

    /**
     * The column <code>ZDB.T_OA_VACATION.END_AT</code>. 「endAt」- 结束时间
     */
    public final TableField<TOaVacationRecord, LocalDateTime> END_AT = createField(DSL.name("END_AT"), SQLDataType.LOCALDATETIME(0), this, "「endAt」- 结束时间");

    /**
     * The column <code>ZDB.T_OA_VACATION.DAYS</code>. 「days」- 天数
     */
    public final TableField<TOaVacationRecord, Integer> DAYS = createField(DSL.name("DAYS"), SQLDataType.INTEGER, this, "「days」- 天数");

    /**
     * The column <code>ZDB.T_OA_VACATION.COMMENT_EXTENSION</code>.
     * 「commentExtension」- 扩展备注
     */
    public final TableField<TOaVacationRecord, String> COMMENT_EXTENSION = createField(DSL.name("COMMENT_EXTENSION"), SQLDataType.CLOB, this, "「commentExtension」- 扩展备注");
    ...
    private TOaVacation(Name alias, Table<TOaVacationRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment("OA - 请假申请"), TableOptions.table(), where);
    }
