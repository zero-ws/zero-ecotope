...
public class ETeam extends TableImpl<ETeamRecord> {
    ...
    /**
     * The column <code>ZDB.E_TEAM.ID</code>. 「id」- 主键
     */
    public final TableField<ETeamRecord, String> ID = createField(DSL.name("ID"), SQLDataType.VARCHAR(36).nullable(false), this, "「id」- 主键");
    ...
    /**
     * The column <code>ZDB.E_TEAM.BIND_ID</code>. 「bindId」- 绑定用户组ID
     */
    public final TableField<ETeamRecord, String> BIND_ID = createField(DSL.name("BIND_ID"), SQLDataType.VARCHAR(36), this, "「bindId」- 绑定用户组ID");

    /**
     * The column <code>ZDB.E_TEAM.CODE</code>. 「code」- 编号
     */
    public final TableField<ETeamRecord, String> CODE = createField(DSL.name("CODE"), SQLDataType.VARCHAR(255), this, "「code」- 编号");

    /**
     * The column <code>ZDB.E_TEAM.COMMENT</code>. 「comment」- 备注
     */
    public final TableField<ETeamRecord, String> COMMENT = createField(DSL.name("COMMENT"), SQLDataType.CLOB(65535), this, "「comment」- 备注");
    ...
    /**
     * The column <code>ZDB.E_TEAM.NAME</code>. 「name」- 名称
     */
    public final TableField<ETeamRecord, String> NAME = createField(DSL.name("NAME"), SQLDataType.VARCHAR(255), this, "「name」- 名称");
     ...
     */
    public final TableField<ETeamRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 统一标识");
    ...
    /**
     * The column <code>ZDB.E_TEAM.LANGUAGE</code>. 「language」- 语言偏好
     */
    public final TableField<ETeamRecord, String> LANGUAGE = createField(DSL.name("LANGUAGE"), SQLDataType.VARCHAR(10), this, "「language」- 语言偏好");

    /**
     * The column <code>ZDB.E_TEAM.METADATA</code>. 「metadata」- 元配置
     */
    public final TableField<ETeamRecord, JsonObject> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 元配置", new JooqJsonObjectConverter());

    /**
     * The column <code>ZDB.E_TEAM.VERSION</code>. 「version」- 版本号
     */
    public final TableField<ETeamRecord, String> VERSION = createField(DSL.name("VERSION"), SQLDataType.VARCHAR(64), this, "「version」- 版本号");
    ...
    private ETeam(Name alias, Table<ETeamRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment("E_TEAM"), TableOptions.table(), where);
    }
    ...
    public List<UniqueKey<ETeamRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_E_TEAM_UK_E_TEAM_CODE_DEPT_ID, Keys.KEY_E_TEAM_UK_E_TEAM_NAME_DEPT_ID_TEAM_ID);
    }
