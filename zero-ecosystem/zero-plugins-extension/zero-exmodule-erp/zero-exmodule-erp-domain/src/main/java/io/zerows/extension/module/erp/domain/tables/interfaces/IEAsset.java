...
public interface IEAsset extends VertxPojo, Serializable {
    ...
    public default IEAsset fromJson(io.vertx.core.json.JsonObject json) {
        ...
        setOrThrow(this::setVOriginal, key -> {
            String s = json.getString(key);
            return s == null ? null : new java.math.BigDecimal(s);
        }, "V_ORIGINAL", "java.math.BigDecimal");
        setOrThrow(this::setVTax, key -> {
            String s = json.getString(key);
            return s == null ? null : new java.math.BigDecimal(s);
        }, "V_TAX", "java.math.BigDecimal");
        setOrThrow(this::setVDeReady, key -> {
            String s = json.getString(key);
            return s == null ? null : new java.math.BigDecimal(s);
        }, "V_DE_READY", "java.math.BigDecimal");
        setOrThrow(this::setVNetJunk, key -> {
            String s = json.getString(key);
            return s == null ? null : new java.math.BigDecimal(s);
        }, "V_NET_JUNK", "java.math.BigDecimal");
        setOrThrow(this::setVNet, key -> {
            String s = json.getString(key);
            return s == null ? null : new java.math.BigDecimal(s);
        }, "V_NET", "java.math.BigDecimal");
        setOrThrow(this::setVNetAmount, key -> {
            String s = json.getString(key);
            return s == null ? null : new java.math.BigDecimal(s);
        }, "V_NET_AMOUNT", "java.math.BigDecimal");
        setOrThrow(this::setVDeprecatedM, key -> {
            String s = json.getString(key);
            return s == null ? null : new java.math.BigDecimal(s);
        }, "V_DEPRECATED_M", "java.math.BigDecimal");
        setOrThrow(this::setVDeprecatedA, key -> {
            String s = json.getString(key);
            return s == null ? null : new java.math.BigDecimal(s);
        }, "V_DEPRECATED_A", "java.math.BigDecimal");
