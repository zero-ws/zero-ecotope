...
public class EEmployee extends TableImpl<EEmployeeRecord> {
    ...
    /**
     * The column <code>ZDB.E_EMPLOYEE.ID</code>. 「id」- 主键
     */
    public final TableField<EEmployeeRecord, String> ID = createField(DSL.name("ID"), SQLDataType.VARCHAR(36).nullable(false), this, "「id」- 主键");
    ...
    /**
     * The column <code>ZDB.E_EMPLOYEE.TYPE</code>. 「type」- 类型
     */
    public final TableField<EEmployeeRecord, String> TYPE = createField(DSL.name("TYPE"), SQLDataType.VARCHAR(36), this, "「type」- 类型");

    /**
     * The column <code>ZDB.E_EMPLOYEE.STATUS</code>. 「status」- 状态
     */
    public final TableField<EEmployeeRecord, String> STATUS = createField(DSL.name("STATUS"), SQLDataType.VARCHAR(36), this, "「status」- 状态");

    /**
     * The column <code>ZDB.E_EMPLOYEE.SIGMA</code>. 「sigma」- 统一标识
     */
    public final TableField<EEmployeeRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(32), this, "「sigma」- 统一标识");
    ...
    /**
     * The column <code>ZDB.E_EMPLOYEE.LANGUAGE</code>. 「language」- 语言偏好
     */
    public final TableField<EEmployeeRecord, String> LANGUAGE = createField(DSL.name("LANGUAGE"), SQLDataType.VARCHAR(10), this, "「language」- 语言偏好");

    /**
     * The column <code>ZDB.E_EMPLOYEE.METADATA</code>. 「metadata」- 元配置
     */
    public final TableField<EEmployeeRecord, JsonObject> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 元配置", new JooqJsonObjectConverter());

    /**
     * The column <code>ZDB.E_EMPLOYEE.VERSION</code>. 「version」- 版本号
     */
    public final TableField<EEmployeeRecord, String> VERSION = createField(DSL.name("VERSION"), SQLDataType.VARCHAR(64), this, "「version」- 版本号");
    ...
    private EEmployee(Name alias, Table<EEmployeeRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment("员工"), TableOptions.table(), where);
    }
    ...
    public List<UniqueKey<EEmployeeRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_E_EMPLOYEE_UK_E_EMPLOYEE_WORK_NUMBER_COMPANY_ID);
    }
