...
public class KpDimension extends TableImpl<KpDimensionRecord> {
    ...
    /**
     * The column <code>ZDB.KP_DIMENSION.ID</code>. 「id」- 主键
     */
    public final TableField<KpDimensionRecord, String> ID = createField(DSL.name("ID"), SQLDataType.VARCHAR(36).nullable(false), this, "「id」- 主键");
    ...
    /**
     * The column <code>ZDB.KP_DIMENSION.CODE</code>. 「code」- 编号
     */
    public final TableField<KpDimensionRecord, String> CODE = createField(DSL.name("CODE"), SQLDataType.VARCHAR(255), this, "「code」- 编号");
    ...
    /**
     * The column <code>ZDB.KP_DIMENSION.NAME</code>. 「name」- 名称
     */
    public final TableField<KpDimensionRecord, String> NAME = createField(DSL.name("NAME"), SQLDataType.VARCHAR(255), this, "「name」- 名称");
    ...
    /**
     * The column <code>ZDB.KP_DIMENSION.TYPE</code>. 「type」- 类型
     */
    public final TableField<KpDimensionRecord, String> TYPE = createField(DSL.name("TYPE"), SQLDataType.VARCHAR(255), this, "「type」- 类型");

    /**
     * The column <code>ZDB.KP_DIMENSION.STATUS</code>. 「status」- 状态
     */
    public final TableField<KpDimensionRecord, String> STATUS = createField(DSL.name("STATUS"), SQLDataType.VARCHAR(255), this, "「status」- 状态");

    /**
     * The column <code>ZDB.KP_DIMENSION.SIGMA</code>. 「sigma」- 统一标识
     */
    public final TableField<KpDimensionRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 统一标识");
    ...
    /**
     * The column <code>ZDB.KP_DIMENSION.LANGUAGE</code>. 「language」- 语言偏好
     */
    public final TableField<KpDimensionRecord, String> LANGUAGE = createField(DSL.name("LANGUAGE"), SQLDataType.VARCHAR(10), this, "「language」- 语言偏好");
     ...
     */
    public final TableField<KpDimensionRecord, String> VERSION = createField(DSL.name("VERSION"), SQLDataType.VARCHAR(64), this, "「version」- 版本号");
    ...
    private KpDimension(Name alias, Table<KpDimensionRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment("KP_DIMENSION"), TableOptions.table(), where);
    }
    ...
    public List<UniqueKey<KpDimensionRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_KP_DIMENSION_UK_KP_DIMENSION_CODE_REPORT_ID_SIGMA);
    }
