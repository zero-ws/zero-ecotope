...
public class KpReport extends TableImpl<KpReportRecord> {
    ...
    /**
     * The column <code>ZDB.KP_REPORT.ID</code>. 「id」- 主键
     */
    public final TableField<KpReportRecord, String> ID = createField(DSL.name("ID"), SQLDataType.VARCHAR(36).nullable(false), this, "「id」- 主键");

    /**
     * The column <code>ZDB.KP_REPORT.CODE</code>. 「code」- 编号
     */
    public final TableField<KpReportRecord, String> CODE = createField(DSL.name("CODE"), SQLDataType.VARCHAR(36), this, "「code」- 编号");
    ...
    /**
     * The column <code>ZDB.KP_REPORT.NAME</code>. 「name」- 名称
     */
    public final TableField<KpReportRecord, String> NAME = createField(DSL.name("NAME"), SQLDataType.VARCHAR(255), this, "「name」- 名称");
     ...
     */
    public final TableField<KpReportRecord, String> TITLE = createField(DSL.name("TITLE"), SQLDataType.VARCHAR(255), this, "「title」- 标题");

    /**
     * The column <code>ZDB.KP_REPORT.STATUS</code>. 「status」- 状态
     */
    public final TableField<KpReportRecord, String> STATUS = createField(DSL.name("STATUS"), SQLDataType.VARCHAR(255), this, "「status」- 状态");

    /**
     * The column <code>ZDB.KP_REPORT.SIGMA</code>. 「sigma」- 统一标识
     */
    public final TableField<KpReportRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 统一标识");
    ...
    /**
     * The column <code>ZDB.KP_REPORT.LANGUAGE</code>. 「language」- 语言偏好
     */
    public final TableField<KpReportRecord, String> LANGUAGE = createField(DSL.name("LANGUAGE"), SQLDataType.VARCHAR(10), this, "「language」- 语言偏好");
     ...
     */
    public final TableField<KpReportRecord, String> VERSION = createField(DSL.name("VERSION"), SQLDataType.VARCHAR(64), this, "「version」- 版本号");
    ...
    private KpReport(Name alias, Table<KpReportRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment("KP_REPORT"), TableOptions.table(), where);
    }
    ...
    public List<UniqueKey<KpReportRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_KP_REPORT_UK_KP_REPORT_CODE_SIGMA, Keys.KEY_KP_REPORT_UK_KP_REPORT_NAME_SIGMA);
    }
