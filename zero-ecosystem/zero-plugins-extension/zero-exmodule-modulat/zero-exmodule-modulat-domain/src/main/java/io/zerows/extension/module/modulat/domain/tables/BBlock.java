...
public class BBlock extends TableImpl<BBlockRecord> {
    ...
    /**
     * The column <code>ZDB.B_BLOCK.ID</code>. 「id」- 主键
     */
    public final TableField<BBlockRecord, String> ID = createField(DSL.name("ID"), SQLDataType.VARCHAR(36).nullable(false), this, "「id」- 主键");
    ...
    /**
     * The column <code>ZDB.B_BLOCK.CODE</code>. 「code」- 编号
     */
    public final TableField<BBlockRecord, String> CODE = createField(DSL.name("CODE"), SQLDataType.VARCHAR(255), this, "「code」- 编号");
     ...
     */
    public final TableField<BBlockRecord, String> NAME = createField(DSL.name("NAME"), SQLDataType.VARCHAR(255), this, "「name」- 名称");
    ...
    /**
     * The column <code>ZDB.B_BLOCK.TENANT_ID</code>. 「tenantId」- 租户ID
     */
    public final TableField<BBlockRecord, String> TENANT_ID = createField(DSL.name("TENANT_ID"), SQLDataType.VARCHAR(36), this, "「tenantId」- 租户ID");

    /**
     * The column <code>ZDB.B_BLOCK.APP_ID</code>. 「appId」- 应用ID
     */
    ...
    private BBlock(Name alias, Table<BBlockRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment("B_BLOCK"), TableOptions.table(), where);
    }
    ...
    public List<UniqueKey<BBlockRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_B_BLOCK_UK_B_BLOCK_CODE_APP_ID, Keys.KEY_B_BLOCK_UK_B_BLOCK_NAME_APP_ID_BAG_ID, Keys.KEY_B_BLOCK_UK_B_BLOCK_SIGN_SECRET);
    }
     ...
     */
    @Override
    public BBlock where(Condition condition) {
        return new BBlock(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public BBlock where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public BBlock where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public BBlock where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public BBlock where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public BBlock where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public BBlock where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public BBlock where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public BBlock whereExists(Select<?> select) {
     ...
     */
    @Override
    public BBlock whereNotExists(Select<?> select) {
