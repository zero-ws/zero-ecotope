...
public class BBlock extends TableImpl<BBlockRecord> {
    ...
    /**
     * The column <code>ZDB.B_BLOCK.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    public final TableField<BBlockRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 用户组绑定的统一标识");

    /**
     * The column <code>ZDB.B_BLOCK.LANGUAGE</code>. 「language」- 使用的语言
     */
    public final TableField<BBlockRecord, String> LANGUAGE = createField(DSL.name("LANGUAGE"), SQLDataType.VARCHAR(10), this, "「language」- 使用的语言");
    ...
    /**
     * The column <code>ZDB.B_BLOCK.METADATA</code>. 「metadata」- 附加配置数据
     */
    public final TableField<BBlockRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
