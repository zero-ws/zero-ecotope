...
import io.zerows.extension.module.modulat.component.Combiner;
...
import io.zerows.extension.module.modulat.management.PowerApp;
...
public class BagArgService implements BagArgStub {
    ...
    private Future<JsonObject> saveConfigure(final BBag bag, final JsonObject data) {
        ...
        return this.seekBlocks(bag)
            ...
            // Refresh Cache of id
            .compose(config -> PowerApp.getRefresh(bag.getAppId(), false)
