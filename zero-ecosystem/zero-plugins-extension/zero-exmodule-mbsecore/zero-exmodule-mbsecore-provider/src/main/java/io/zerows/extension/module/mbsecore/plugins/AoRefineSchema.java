...
import io.zerows.extension.module.mbsecore.component.jdbc.Pin;
import io.zerows.extension.module.mbsecore.component.metadata.AoBuilder;
import io.zerows.extension.module.mbsecore.domain.tables.daos.MEntityDao;
import io.zerows.extension.module.mbsecore.domain.tables.daos.MFieldDao;
...
@Slf4j
class AoRefineSchema implements AoRefine {
    ...
    private Future<JsonArray> saveKey(final Schema schema, final MEntity entity) {
        ...
        final ADB jq = DB.on(MKeyDao.class);
    ...
    private Future<JsonArray> saveField(final Schema schema, final MEntity entity) {
        ...
        final ADB jq = DB.on(MFieldDao.class);
