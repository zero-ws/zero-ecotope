package io.zerows.extension.module.mbsecore.component.dao;

import io.vertx.core.Future;
import io.vertx.core.json.JsonObject;
import io.zerows.component.log.LogOf;
import io.zerows.component.qr.Criteria;
import io.zerows.extension.module.mbsecore.component.dao.internal.UAggr;
import io.zerows.extension.module.mbsecore.component.dao.internal.UFlush;
import io.zerows.extension.module.mbsecore.component.dao.internal.UList;
import io.zerows.extension.module.mbsecore.component.dao.internal.USearch;
import io.zerows.extension.module.mbsecore.component.dao.internal.UUnique;
...
public abstract class AbstractDao implements HDao {
    ...
    public Long count(final Criteria criteria) {
        return this.aggr.count(criteria);
    }
    ...
    public Boolean exist(final Criteria criteria) {
        return this.aggr.existing(criteria);
    }
    ...
    public Boolean miss(final Criteria criteria) {
        return this.aggr.missing(criteria);
    }
    ...
    public HRecord insert(final HRecord record) {
        return this.flush.insert(record);
    }
...
/*        if (Objects.isNull(records)) {
    ...
    public HRecord update(final HRecord record) {
        return this.flush.update(record);
    }
    ...
    public <ID> HRecord fetchById(final ID id) {
        return this.unique.fetchById(id);
    }
...
/*        if (Objects.isNull(ids)) {
    ...
    public HRecord fetchOne(final Criteria criteria) {
        return this.unique.fetchOne(criteria);
    }
    ...
    public HRecord[] fetch(final JsonObject criteria) {
        return this.search.query(criteria);
    }
    ...
    public boolean delete(final HRecord record) {
        return this.flush.delete(record);
    }
