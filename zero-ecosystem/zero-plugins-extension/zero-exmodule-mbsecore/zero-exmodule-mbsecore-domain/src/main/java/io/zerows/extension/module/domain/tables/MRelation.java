...
public class MRelation extends TableImpl<MRelationRecord> {
    ...
    /**
     * The column <code>ZDB.M_RELATION.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    public final TableField<MRelationRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 用户组绑定的统一标识");
     ...
     */
    public final TableField<MRelationRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
