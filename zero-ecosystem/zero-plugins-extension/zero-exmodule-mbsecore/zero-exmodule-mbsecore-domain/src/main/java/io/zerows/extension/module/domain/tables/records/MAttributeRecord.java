...
import io.zerows.extension.module.domain.tables.interfaces.IMAttribute;
...
public class MAttributeRecord extends UpdatableRecordImpl<MAttributeRecord> implements VertxPojo, IMAttribute {
    ...
    /**
     * Setter for <code>ZDB.M_ATTRIBUTE.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.M_ATTRIBUTE.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    @Override
