...
CREATE TABLE IF NOT EXISTS `M_KEY` (
    ...
    -- ==================================================================================================
    `COLUMNS`     TEXT          COLLATE utf8mb4_bin COMMENT '「columns」- JsonArra',                          -- JsonArray格式，键覆盖的列集合
    ...
    UNIQUE KEY `UK_M_KEY_NAME_ENTITY_ID` (`NAME`, `ENTITY_ID`) USING BTREE,
    KEY `IDX_M_KEY_ENTITY_ID` (`ENTITY_ID`) USING BTREE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_bin COMMENT='M_KEY';
