...
public interface IPBuyOrder extends VertxPojo, Serializable {
    ...
    public default IPBuyOrder fromJson(io.vertx.core.json.JsonObject json) {
        ...
        setOrThrow(this::setAmountWait, key -> {
            String s = json.getString(key);
            return s == null ? null : new java.math.BigDecimal(s);
        }, "AMOUNT_WAIT", "java.math.BigDecimal");
        setOrThrow(this::setAmountDebt, key -> {
            String s = json.getString(key);
            return s == null ? null : new java.math.BigDecimal(s);
        }, "AMOUNT_DEBT", "java.math.BigDecimal");
        setOrThrow(this::setAmountPlan, key -> {
            String s = json.getString(key);
            return s == null ? null : new java.math.BigDecimal(s);
        }, "AMOUNT_PLAN", "java.math.BigDecimal");
        setOrThrow(this::setAmountYes, key -> {
            String s = json.getString(key);
            return s == null ? null : new java.math.BigDecimal(s);
        }, "AMOUNT_YES", "java.math.BigDecimal");
