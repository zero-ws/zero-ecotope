...
public class MJoinDao extends AbstractVertxDAO<MJoinRecord, io.zerows.extension.mbse.basement.domain.tables.pojos.MJoin, Record4<String, String, String, String>, Future<List<io.zerows.extension.mbse.basement.domain.tables.pojos.MJoin>>, Future<io.zerows.extension.mbse.basement.domain.tables.pojos.MJoin>, Future<Integer>, Future<Record4<String, String, String, String>>> implements io.r2mo.vertx.jooq.classic.VertxDAO<MJoinRecord, io.zerows.extension.mbse.basement.domain.tables.pojos.MJoin, Record4<String, String, String, String>> {
    ...
    @Override
    protected Record4<String, String, String, String> getId(final io.zerows.extension.mbse.basement.domain.tables.pojos.MJoin object) {
     ...
     */
    public Future<List<io.zerows.extension.mbse.basement.domain.tables.pojos.MJoin>> findManyByEntity(final Collection<String> values) {
     ...
     */
    public Future<List<io.zerows.extension.mbse.basement.domain.tables.pojos.MJoin>> findManyByEntity(final Collection<String> values, final int limit) {
     ...
     */
    public Future<List<io.zerows.extension.mbse.basement.domain.tables.pojos.MJoin>> findManyByEntityKey(final Collection<String> values) {
     ...
     * limited by the given limit
     */
    public Future<List<io.zerows.extension.mbse.basement.domain.tables.pojos.MJoin>> findManyByEntityKey(final Collection<String> values, final int limit) {
     ...
     */
    public Future<List<io.zerows.extension.mbse.basement.domain.tables.pojos.MJoin>> findManyByPriority(final Collection<Integer> values) {
     ...
     * limited by the given limit
     */
    public Future<List<io.zerows.extension.mbse.basement.domain.tables.pojos.MJoin>> findManyByPriority(final Collection<Integer> values, final int limit) {
     ...
     */
    public Future<List<io.zerows.extension.mbse.basement.domain.tables.pojos.MJoin>> findManyByNamespace(final Collection<String> values) {
     ...
     * limited by the given limit
     */
    public Future<List<io.zerows.extension.mbse.basement.domain.tables.pojos.MJoin>> findManyByNamespace(final Collection<String> values, final int limit) {
