...
import io.zerows.extension.module.workflow.component.conformity.Gear;
...
public class WTransition {
    ...
    public PassWay vague() {
         ...
         * 	at io.vertx.mod.running.argument.workflow.WTransition.vague(WTransition.java:127)
         */
     ...
     * will be filled the findRunning based join different Gear
     * 1) Standard
     * 2) Fork/Join
     * 3) Multi
     * 4) Grid
    ...
    public Future<WTransition> start() {
        ...
        if (Ut.isNil(taskId)) {
             ...
             * 2) The move = findRunning ( Not be null, at least Empty )
             */
             ...
             * 1) The from = findRunning
             * 2) The move = findRunning
             */
    ...
    public boolean isEnded() {
         ...
         * 2. The history instance has been created and could be findRunning
