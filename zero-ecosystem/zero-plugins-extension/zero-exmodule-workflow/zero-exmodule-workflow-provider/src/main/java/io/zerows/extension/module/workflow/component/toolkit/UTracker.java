package io.zerows.extension.module.workflow.component.toolkit;
...
import io.zerows.extension.module.workflow.plugins.AfterActivityTabb;
...
public class UTracker {
    ...
    private Aspect aspect(final WTransition transition) {
        ...
        aspectConfig.afterQueue(AfterActivityTabb.class, config);
