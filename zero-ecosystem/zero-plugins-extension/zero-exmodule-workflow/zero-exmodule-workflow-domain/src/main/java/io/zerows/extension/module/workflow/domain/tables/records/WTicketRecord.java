...
public class WTicketRecord extends UpdatableRecordImpl<WTicketRecord> implements VertxPojo, IWTicket {
    ...
    /**
     * Getter for <code>ZDB.W_TICKET.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.W_TICKET.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.W_TICKET.METADATA</code>. 「metadata」- 附加配置数据
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.W_TICKET.METADATA</code>. 「metadata」- 附加配置数据
     */
    @Override
