...
public class WTodoRecord extends UpdatableRecordImpl<WTodoRecord> implements VertxPojo, IWTodo {
     ...
     */
    public WTodoRecord(String key, String serial, String name, String code, String icon, String status, String todoUrl, String type, LocalDateTime expiredAt, String modelId, String modelKey, String modelCategory, String parentId, String serialFork, String traceId, Integer traceOrder, String taskId, String taskKey, String comment, String commentApproval, String commentReject, String toLocation, String toGroup, String toTeam, String toRole, String toUser, String toDept, Boolean escalate, String escalateData, String assignedBy, LocalDateTime assignedAt, String acceptedBy, String acceptedGroup, LocalDateTime acceptedAt, String finishedBy, LocalDateTime finishedAt, String sigma, String language, Boolean active, String metadata, LocalDateTime createdAt, String createdBy, LocalDateTime updatedAt, String updatedBy, String appId, String tenantId) {
        super(WTodo.W_TODO);
    ...
    /**
     * Getter for <code>ZDB.W_TODO.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.W_TODO.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.W_TODO.METADATA</code>. 「metadata」- 附加配置数据
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.W_TODO.METADATA</code>. 「metadata」- 附加配置数据
     */
    @Override
