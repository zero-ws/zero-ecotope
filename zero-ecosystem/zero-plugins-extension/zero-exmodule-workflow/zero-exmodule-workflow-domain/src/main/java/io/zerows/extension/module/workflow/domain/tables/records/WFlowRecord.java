...
public class WFlowRecord extends UpdatableRecordImpl<WFlowRecord> implements VertxPojo, IWFlow {
    ...
    /**
     * Setter for <code>ZDB.W_FLOW.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.W_FLOW.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.W_FLOW.METADATA</code>. 「metadata」- 附加配置数据
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.W_FLOW.METADATA</code>. 「metadata」- 附加配置数据
     */
    @Override
