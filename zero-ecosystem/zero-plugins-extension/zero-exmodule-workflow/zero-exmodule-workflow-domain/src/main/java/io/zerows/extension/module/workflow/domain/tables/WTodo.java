...
public class WTodo extends TableImpl<WTodoRecord> {
    ...
    /**
     * The column <code>ZDB.W_TODO.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    public final TableField<WTodoRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 用户组绑定的统一标识");

    /**
     * The column <code>ZDB.W_TODO.LANGUAGE</code>. 「language」- 使用的语言
     */
    public final TableField<WTodoRecord, String> LANGUAGE = createField(DSL.name("LANGUAGE"), SQLDataType.VARCHAR(10), this, "「language」- 使用的语言");
    ...
    /**
     * The column <code>ZDB.W_TODO.METADATA</code>. 「metadata」- 附加配置数据
     */
    public final TableField<WTodoRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
    ...
    public List<UniqueKey<WTodoRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_W_TODO_SIGMA, Keys.KEY_W_TODO_SIGMA_2);
    }
