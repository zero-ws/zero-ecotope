...
public class WTicket extends TableImpl<WTicketRecord> {
    ...
    /**
     * The column <code>ZDB.W_TICKET.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    public final TableField<WTicketRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 用户组绑定的统一标识");

    /**
     * The column <code>ZDB.W_TICKET.LANGUAGE</code>. 「language」- 使用的语言
     */
    public final TableField<WTicketRecord, String> LANGUAGE = createField(DSL.name("LANGUAGE"), SQLDataType.VARCHAR(10), this, "「language」- 使用的语言");
    ...
    /**
     * The column <code>ZDB.W_TICKET.METADATA</code>. 「metadata」- 附加配置数据
     */
    public final TableField<WTicketRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
    ...
    public List<UniqueKey<WTicketRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_W_TICKET_SIGMA, Keys.KEY_W_TICKET_SIGMA_2);
    }
