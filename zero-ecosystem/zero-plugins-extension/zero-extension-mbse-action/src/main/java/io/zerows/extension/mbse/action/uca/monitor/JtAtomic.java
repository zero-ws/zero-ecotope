...
class JtAtomic {
    ...
    void start(final LogOf logger, final JsonObject config) {
    ...
    void workerDeployed(final LogOf logger, final Integer instances, final String name) {
