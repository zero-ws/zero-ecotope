...
public class DynamicDs implements DS {
    ...
    public DataPool switchDs(final MultiMap headers) {
        ...
        RFn.out(Objects.isNull(ark), _501DataSourceException.class, this.getClass(), headers.toString());
    ...
    public DataPool switchDs(final String sigma) {
        ...
        RFn.out(Objects.isNull(ark), _501DataSourceException.class, this.getClass(), sigma);
        return this.getDs(ark);
    }
