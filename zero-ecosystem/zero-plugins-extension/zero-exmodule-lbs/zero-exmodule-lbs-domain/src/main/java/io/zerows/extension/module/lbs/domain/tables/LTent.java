...
public class LTent extends TableImpl<LTentRecord> {
    ...
    /**
     * The column <code>ZDB.L_TENT.ID</code>. 「id」- 主键
     */
    public final TableField<LTentRecord, String> ID = createField(DSL.name("ID"), SQLDataType.VARCHAR(36).nullable(false), this, "「id」- 主键");

    /**
     * The column <code>ZDB.L_TENT.CODE</code>. 「code」- 编号
     */
    public final TableField<LTentRecord, String> CODE = createField(DSL.name("CODE"), SQLDataType.VARCHAR(36), this, "「code」- 编号");
    ...
    /**
     * The column <code>ZDB.L_TENT.ORDER</code>. 「order」- 顺序
     */
    public final TableField<LTentRecord, Integer> ORDER = createField(DSL.name("ORDER"), SQLDataType.INTEGER, this, "「order」- 顺序");
     ...
     */
    public final TableField<LTentRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 统一标识");
    ...
    /**
     * The column <code>ZDB.L_TENT.LANGUAGE</code>. 「language」- 语言偏好
     */
    public final TableField<LTentRecord, String> LANGUAGE = createField(DSL.name("LANGUAGE"), SQLDataType.VARCHAR(10), this, "「language」- 语言偏好");

    /**
     * The column <code>ZDB.L_TENT.METADATA</code>. 「metadata」- 元配置
     */
    public final TableField<LTentRecord, JsonObject> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 元配置", new JooqJsonObjectConverter());

    /**
     * The column <code>ZDB.L_TENT.VERSION</code>. 「version」- 版本号
     */
    public final TableField<LTentRecord, String> VERSION = createField(DSL.name("VERSION"), SQLDataType.VARCHAR(64), this, "「version」- 版本号");
    ...
    private LTent(Name alias, Table<LTentRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment("L_TENT"), TableOptions.table(), where);
    }
    ...
    public List<UniqueKey<LTentRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_L_TENT_UK_L_TENT_CODE_SIGMA);
    }
