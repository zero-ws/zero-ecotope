...
public class LLocation extends TableImpl<LLocationRecord> {
    ...
    /**
     * The column <code>ZDB.L_LOCATION.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    public final TableField<LLocationRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 用户组绑定的统一标识");
    /**
     * The column <code>ZDB.L_LOCATION.LANGUAGE</code>. 「language」- 使用的语言
     */
    public final TableField<LLocationRecord, String> LANGUAGE = createField(DSL.name("LANGUAGE"), SQLDataType.VARCHAR(10), this, "「language」- 使用的语言");
    /**
    ...
    /**
     * The column <code>ZDB.L_LOCATION.METADATA</code>. 「metadata」- 附加配置数据
     */
    public final TableField<LLocationRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
    /**
