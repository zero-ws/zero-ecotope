...
CREATE TABLE IF NOT EXISTS `L_STATE` (
    ...
    -- ==================================================================================================
    `ALIAS`       VARCHAR(32)   NOT NULL COLLATE utf8mb4_bin COMMENT '「alias」- 别名',
    `CODE`        VARCHAR(36)   DEFAULT NULL COLLATE utf8mb4_bin COMMENT '「code」- 编号',
    `COUNTRY_ID`  VARCHAR(36)   NOT NULL COLLATE utf8mb4_bin COMMENT '「countryId」- 国家ID',
    ...
    UNIQUE KEY `UK_L_STATE_CODE_SIGMA` (`CODE`, `SIGMA`) USING BTREE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_bin COMMENT='L_STATE';
