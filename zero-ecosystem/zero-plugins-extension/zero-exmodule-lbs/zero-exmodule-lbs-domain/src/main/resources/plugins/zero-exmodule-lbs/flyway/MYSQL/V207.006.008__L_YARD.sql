...
CREATE TABLE IF NOT EXISTS `L_YARD` (
    -- ==================================================================================================
    ...
    `LOCATION_ID`  VARCHAR(36)   COLLATE utf8mb4_bin DEFAULT NULL COMMENT '「locationId」- 关联地址ID',
    ...
    UNIQUE KEY `UK_L_YARD_CODE_SIGMA` (`CODE`, `SIGMA`) USING BTREE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_bin COMMENT='L_YARD';
