...
CREATE TABLE IF NOT EXISTS `L_FLOOR` (
    -- ==================================================================================================
    ...
    `TENT_ID`     varchar(36)   DEFAULT NULL COLLATE utf8mb4_bin COMMENT '「tentId」- 栋ID',
    ...
    UNIQUE KEY `UK_L_FLOOR_CODE_SIGMA` (`CODE`, `SIGMA`) USING BTREE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_bin COMMENT='L_FLOOR';
