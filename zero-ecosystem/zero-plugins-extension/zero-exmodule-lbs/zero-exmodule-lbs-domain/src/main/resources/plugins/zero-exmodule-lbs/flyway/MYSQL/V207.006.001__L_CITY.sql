...
CREATE TABLE IF NOT EXISTS `L_CITY` (
    ...
    `STATE_ID`    VARCHAR(36)   NOT NULL COLLATE utf8mb4_bin COMMENT '「stateId」- 省会ID',
    ...
    UNIQUE KEY `UK_L_CITY_CODE_SIGMA` (`CODE`, `SIGMA`) USING BTREE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_bin COMMENT='L_CITY';
