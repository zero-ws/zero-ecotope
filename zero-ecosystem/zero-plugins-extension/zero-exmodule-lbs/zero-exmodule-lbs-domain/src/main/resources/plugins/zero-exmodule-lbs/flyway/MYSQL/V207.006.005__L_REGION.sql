...
CREATE TABLE IF NOT EXISTS `L_REGION` (
    -- ==================================================================================================
    ...
    -- ==================================================================================================
    `CITY_ID`     VARCHAR(36)   NOT NULL COLLATE utf8mb4_bin COMMENT '「cityId」- 城市ID',
    ...
    UNIQUE KEY `UK_L_REGION_CODE_SIGMA` (`CODE`, `SIGMA`) USING BTREE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_bin COMMENT='L_REGION';
