...
import io.zerows.extension.module.ui.domain.tables.daos.UiControlDao;
import io.zerows.extension.module.ui.domain.tables.daos.UiVisitorDao;
import io.zerows.extension.module.ui.domain.tables.pojos.UiControl;
...
public class ControlService implements ControlStub {
    ...
    private static final LogOf LOGGER = LogOf.get(ControlService.class);
