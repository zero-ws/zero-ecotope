...
public class UiFieldRecord extends UpdatableRecordImpl<UiFieldRecord> implements VertxPojo, IUiField {
    ...
    /**
     * Setter for <code>ZDB.UI_FIELD.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.UI_FIELD.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.UI_FIELD.METADATA</code>. 「metadata」- 附加配置数据
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.UI_FIELD.METADATA</code>. 「metadata」- 附加配置数据
     */
    @Override
     ...
     */
    public UiFieldRecord(String key, Integer xPoint, Integer yPoint, String label, String name, Integer span, Boolean hidden, String render, String container, String optionJsx, String optionConfig, String optionItem, String rules, String controlId, String rowType, String sigma, String language, Boolean active, String metadata, LocalDateTime createdAt, String createdBy, LocalDateTime updatedAt, String updatedBy, String appId, String tenantId) {
        super(UiField.UI_FIELD);
