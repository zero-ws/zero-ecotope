...
public class UiPage extends TableImpl<UiPageRecord> {
     ...
     */
    public final TableField<UiPageRecord, String> PARAM_MAP = createField(DSL.name("PARAM_MAP"), SQLDataType.CLOB(65535), this, "「paramMap」- URL地址中的配置key=findRunning");
     ...
     */
    public final TableField<UiPageRecord, String> STATE = createField(DSL.name("STATE"), SQLDataType.CLOB(65535), this, "「state」- 当前页面的初始化状态信息");

    /**
     * The column <code>ZDB.UI_PAGE.GRID</code>. 「grid」- 当前页面的布局信息，Grid布局格式
     */
    public final TableField<UiPageRecord, String> GRID = createField(DSL.name("GRID"), SQLDataType.CLOB(65535), this, "「grid」- 当前页面的布局信息，Grid布局格式");

    /**
     * The column <code>ZDB.UI_PAGE.ASSIST</code>. 「assist」- 当前页面的辅助数据Ajax配置
     */
    public final TableField<UiPageRecord, String> ASSIST = createField(DSL.name("ASSIST"), SQLDataType.CLOB(65535), this, "「assist」- 当前页面的辅助数据Ajax配置");

    /**
     * The column <code>ZDB.UI_PAGE.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    public final TableField<UiPageRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 用户组绑定的统一标识");

    /**
     * The column <code>ZDB.UI_PAGE.LANGUAGE</code>. 「language」- 使用的语言
     */
    public final TableField<UiPageRecord, String> LANGUAGE = createField(DSL.name("LANGUAGE"), SQLDataType.VARCHAR(10), this, "「language」- 使用的语言");
    ...
    /**
     * The column <code>ZDB.UI_PAGE.METADATA</code>. 「metadata」- 附加配置数据
     */
    public final TableField<UiPageRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
