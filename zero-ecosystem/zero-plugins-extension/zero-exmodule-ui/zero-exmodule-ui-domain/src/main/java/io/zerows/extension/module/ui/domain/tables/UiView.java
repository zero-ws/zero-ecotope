...
public class UiView extends TableImpl<UiViewRecord> {
     ...
     */
    public final TableField<UiViewRecord, String> ROWS = createField(DSL.name("ROWS"), SQLDataType.CLOB(65535), this, "「rows」- 该资源针对保存的行进行过滤");
     ...
     */
    public final TableField<UiViewRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
