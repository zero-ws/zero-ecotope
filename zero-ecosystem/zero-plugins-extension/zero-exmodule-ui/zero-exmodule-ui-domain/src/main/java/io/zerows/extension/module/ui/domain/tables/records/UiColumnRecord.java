...
public class UiColumnRecord extends UpdatableRecordImpl<UiColumnRecord> implements VertxPojo, IUiColumn {
    ...
    /**
     * Getter for <code>ZDB.UI_COLUMN.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.UI_COLUMN.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.UI_COLUMN.METADATA</code>. 「metadata」- 附加配置数据
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.UI_COLUMN.METADATA</code>. 「metadata」- 附加配置数据
     */
    @Override
