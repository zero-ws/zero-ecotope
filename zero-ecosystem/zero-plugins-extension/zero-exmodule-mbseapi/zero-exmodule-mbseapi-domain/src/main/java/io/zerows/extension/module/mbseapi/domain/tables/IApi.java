...
public class IApi extends TableImpl<IApiRecord> {
     ...
     */
    public final TableField<IApiRecord, String> CONSUMES = createField(DSL.name("CONSUMES"), SQLDataType.CLOB(65535), this, "「consumes」- 当前接口使用的客户端 MIME");

    /**
     * The column <code>ZDB.I_API.PRODUCES</code>. 「produces」- 当前接口使用的服务端 MIME
     */
    public final TableField<IApiRecord, String> PRODUCES = createField(DSL.name("PRODUCES"), SQLDataType.CLOB(65535), this, "「produces」- 当前接口使用的服务端 MIME");
     ...
     */
    public final TableField<IApiRecord, String> COMMENT = createField(DSL.name("COMMENT"), SQLDataType.CLOB(65535), this, "「comment」- 备注信息");
     ...
     */
    public final TableField<IApiRecord, String> PARAM_REQUIRED = createField(DSL.name("PARAM_REQUIRED"), SQLDataType.CLOB(65535), this, "「paramRequired」- 必须参数表，一个JsonArray用于返回 400基本验证（验证Query和Path）");

    /**
     * The column <code>ZDB.I_API.PARAM_CONTAINED</code>. 「paramContained」-
     * 必须参数表，一个JsonArray用于返回 400基本验证（验证Body）
     */
    public final TableField<IApiRecord, String> PARAM_CONTAINED = createField(DSL.name("PARAM_CONTAINED"), SQLDataType.CLOB(65535), this, "「paramContained」- 必须参数表，一个JsonArray用于返回 400基本验证（验证Body）");

    /**
     * The column <code>ZDB.I_API.IN_RULE</code>. 「inRule」- 参数验证、转换基本规则
     */
    public final TableField<IApiRecord, String> IN_RULE = createField(DSL.name("IN_RULE"), SQLDataType.CLOB(65535), this, "「inRule」- 参数验证、转换基本规则");
    ...
    /**
     * The column <code>ZDB.I_API.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    public final TableField<IApiRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 用户组绑定的统一标识");
     ...
     */
    public final TableField<IApiRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
