...
public class Indexes {
    ...
    public static final Index I_SERVICE_IDX_I_SERVICE_SIGMA = Internal.createIndex(DSL.name("IDX_I_SERVICE_SIGMA"), IService.I_SERVICE, new OrderField[] { IService.I_SERVICE.SIGMA }, false);
