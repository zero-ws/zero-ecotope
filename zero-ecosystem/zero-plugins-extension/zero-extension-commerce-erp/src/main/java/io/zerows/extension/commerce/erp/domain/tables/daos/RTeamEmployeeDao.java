...
public class RTeamEmployeeDao extends AbstractVertxDAO<RTeamEmployeeRecord, io.zerows.extension.commerce.erp.domain.tables.pojos.RTeamEmployee, Record2<String, String>, Future<List<io.zerows.extension.commerce.erp.domain.tables.pojos.RTeamEmployee>>, Future<io.zerows.extension.commerce.erp.domain.tables.pojos.RTeamEmployee>, Future<Integer>, Future<Record2<String, String>>> implements io.r2mo.vertx.jooq.classic.VertxDAO<RTeamEmployeeRecord, io.zerows.extension.commerce.erp.domain.tables.pojos.RTeamEmployee, Record2<String, String>> {
     ...
     */
    public RTeamEmployeeDao(final Configuration configuration, final io.vertx.core.Vertx vertx) {
    ...
    @Override
    protected Record2<String, String> getId(final io.zerows.extension.commerce.erp.domain.tables.pojos.RTeamEmployee object) {
     ...
     * asynchronously
     */
    public Future<List<io.zerows.extension.commerce.erp.domain.tables.pojos.RTeamEmployee>> findManyByEmployeeId(final Collection<String> values) {
     ...
     */
    public Future<List<io.zerows.extension.commerce.erp.domain.tables.pojos.RTeamEmployee>> findManyByEmployeeId(final Collection<String> values, final int limit) {
     ...
     * asynchronously
     */
    public Future<List<io.zerows.extension.commerce.erp.domain.tables.pojos.RTeamEmployee>> findManyByLinkComponent(final Collection<String> values) {
     ...
     * asynchronously limited by the given limit
     */
    public Future<List<io.zerows.extension.commerce.erp.domain.tables.pojos.RTeamEmployee>> findManyByLinkComponent(final Collection<String> values, final int limit) {
     ...
     */
    public Future<List<io.zerows.extension.commerce.erp.domain.tables.pojos.RTeamEmployee>> findManyByComment(final Collection<String> values) {
     ...
     */
    public Future<List<io.zerows.extension.commerce.erp.domain.tables.pojos.RTeamEmployee>> findManyByComment(final Collection<String> values, final int limit) {
