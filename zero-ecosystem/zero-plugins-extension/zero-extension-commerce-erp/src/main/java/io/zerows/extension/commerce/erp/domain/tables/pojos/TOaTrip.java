...
public class TOaTrip implements VertxPojo, ITOaTrip {
    ...
    public TOaTrip(final ITOaTrip value) {
    ...
    public TOaTrip(final io.vertx.core.json.JsonObject json) {
        this();
        fromJson(json);
    }
     ...
     */
    @Override
    public TOaTrip setKey(final String key) {
        this.key = key;
        return this;
    }
     ...
     */
    @Override
    public TOaTrip setCommentExtension(final String commentExtension) {
        this.commentExtension = commentExtension;
        return this;
    }
     ...
     */
    @Override
    public TOaTrip setRequestBy(final String requestBy) {
        this.requestBy = requestBy;
        return this;
    }
     ...
     */
    @Override
    public TOaTrip setStartAt(final LocalDateTime startAt) {
        this.startAt = startAt;
        return this;
    }
     ...
     */
    @Override
    public TOaTrip setEndAt(final LocalDateTime endAt) {
        this.endAt = endAt;
        return this;
    }
     ...
     */
    @Override
    public TOaTrip setDays(final Integer days) {
        this.days = days;
        return this;
    }
     ...
     */
    @Override
    public TOaTrip setTripProvince(final String tripProvince) {
        this.tripProvince = tripProvince;
        return this;
    }
     ...
     */
    @Override
    public TOaTrip setTripCity(final String tripCity) {
        this.tripCity = tripCity;
        return this;
    }
     ...
     */
    @Override
    public TOaTrip setTripAddress(final String tripAddress) {
        this.tripAddress = tripAddress;
        return this;
    }
     ...
     */
    @Override
    public TOaTrip setReason(final String reason) {
        this.reason = reason;
        return this;
    }
     ...
     */
    @Override
    public TOaTrip setWorkContent(final String workContent) {
        this.workContent = workContent;
        return this;
    }
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("TOaTrip (");
