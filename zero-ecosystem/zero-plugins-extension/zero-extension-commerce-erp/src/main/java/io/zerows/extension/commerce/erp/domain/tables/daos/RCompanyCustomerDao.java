...
public class RCompanyCustomerDao extends AbstractVertxDAO<RCompanyCustomerRecord, io.zerows.extension.commerce.erp.domain.tables.pojos.RCompanyCustomer, Record2<String, String>, Future<List<io.zerows.extension.commerce.erp.domain.tables.pojos.RCompanyCustomer>>, Future<io.zerows.extension.commerce.erp.domain.tables.pojos.RCompanyCustomer>, Future<Integer>, Future<Record2<String, String>>> implements io.r2mo.vertx.jooq.classic.VertxDAO<RCompanyCustomerRecord, io.zerows.extension.commerce.erp.domain.tables.pojos.RCompanyCustomer, Record2<String, String>> {
     ...
     */
    public RCompanyCustomerDao(final Configuration configuration, final io.vertx.core.Vertx vertx) {
    ...
    @Override
    protected Record2<String, String> getId(final io.zerows.extension.commerce.erp.domain.tables.pojos.RCompanyCustomer object) {
     ...
     * asynchronously
     */
    public Future<List<io.zerows.extension.commerce.erp.domain.tables.pojos.RCompanyCustomer>> findManyByCustomerId(final Collection<String> values) {
     ...
     */
    public Future<List<io.zerows.extension.commerce.erp.domain.tables.pojos.RCompanyCustomer>> findManyByCustomerId(final Collection<String> values, final int limit) {
     ...
     * asynchronously
     */
    public Future<List<io.zerows.extension.commerce.erp.domain.tables.pojos.RCompanyCustomer>> findManyByLinkComponent(final Collection<String> values) {
     ...
     * asynchronously limited by the given limit
     */
    public Future<List<io.zerows.extension.commerce.erp.domain.tables.pojos.RCompanyCustomer>> findManyByLinkComponent(final Collection<String> values, final int limit) {
     ...
     */
    public Future<List<io.zerows.extension.commerce.erp.domain.tables.pojos.RCompanyCustomer>> findManyByComment(final Collection<String> values) {
     ...
     */
    public Future<List<io.zerows.extension.commerce.erp.domain.tables.pojos.RCompanyCustomer>> findManyByComment(final Collection<String> values, final int limit) {
