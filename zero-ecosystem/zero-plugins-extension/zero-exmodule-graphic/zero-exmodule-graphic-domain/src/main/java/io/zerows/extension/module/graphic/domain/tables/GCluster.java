...
public class GCluster extends TableImpl<GClusterRecord> {
    ...
    /**
     * The column <code>ZDB.G_CLUSTER.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    public final TableField<GClusterRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 用户组绑定的统一标识");
     ...
     */
    public final TableField<GClusterRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
