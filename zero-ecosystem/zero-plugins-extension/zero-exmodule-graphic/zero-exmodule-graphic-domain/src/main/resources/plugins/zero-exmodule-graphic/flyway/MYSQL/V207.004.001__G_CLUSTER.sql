...
CREATE TABLE IF NOT EXISTS `G_CLUSTER` (
    ...
    `X`            INT           DEFAULT NULL COMMENT '「x」 - 当前组在图上的x坐标',
    `Y`            INT           DEFAULT NULL COMMENT '「y」 - 当前组在图上的y坐标',
    ...
    UNIQUE KEY `UK_G_CLUSTER_NAME_GRAPHIC_ID` (`NAME`, `GRAPHIC_ID`) USING BTREE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_bin COMMENT='G_CLUSTER';
