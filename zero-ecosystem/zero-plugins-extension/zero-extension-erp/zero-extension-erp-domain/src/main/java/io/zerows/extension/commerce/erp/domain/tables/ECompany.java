...
public class ECompany extends TableImpl<ECompanyRecord> {
     ...
     */
    public final TableField<ECompanyRecord, String> COMMENT = createField(DSL.name("COMMENT"), SQLDataType.CLOB(65535), this, "「comment」- 公司简介");
    ...
    public List<UniqueKey<ECompanyRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_E_COMPANY_CODE, Keys.KEY_E_COMPANY_CUSTOMER_ID, Keys.KEY_E_COMPANY_NAME, Keys.KEY_E_COMPANY_TAX_CODE);
    }
