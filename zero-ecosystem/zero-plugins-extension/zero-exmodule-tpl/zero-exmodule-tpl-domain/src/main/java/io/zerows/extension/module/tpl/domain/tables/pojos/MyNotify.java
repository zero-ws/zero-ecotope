...
public class MyNotify implements VertxPojo, IMyNotify {
    ...
    public MyNotify(final IMyNotify value) {
    ...
    public MyNotify(
        ...
        final String configInternal,
        final String configEmail,
        final String configSms,
        final String appId,
    ...
    public MyNotify(final io.vertx.core.json.JsonObject json) {
        this();
        fromJson(json);
    }
     ...
     */
    @Override
    public MyNotify setKey(final String key) {
        this.key = key;
        return this;
    }
     ...
     */
    @Override
    public MyNotify setOwnerType(final String ownerType) {
        this.ownerType = ownerType;
        return this;
    }
     ...
     */
    @Override
    public MyNotify setOwnerId(final String ownerId) {
        this.ownerId = ownerId;
        return this;
    }
     ...
     */
    @Override
    public MyNotify setConfigInternal(final String configInternal) {
        this.configInternal = configInternal;
        return this;
    }
     ...
     */
    @Override
    public MyNotify setConfigEmail(final String configEmail) {
        this.configEmail = configEmail;
        return this;
    }
     ...
     */
    @Override
    public MyNotify setConfigSms(final String configSms) {
        this.configSms = configSms;
        return this;
    }
     ...
     */
    @Override
    public MyNotify setAppId(final String appId) {
        this.appId = appId;
        return this;
    }
     ...
     */
    @Override
    public MyNotify setActive(final Boolean active) {
        this.active = active;
        return this;
    }
     ...
     */
    @Override
    public MyNotify setSigma(final String sigma) {
        this.sigma = sigma;
        return this;
    }
     ...
     */
    @Override
    public MyNotify setMetadata(final String metadata) {
        this.metadata = metadata;
        return this;
    }
     ...
     */
    @Override
    public MyNotify setLanguage(final String language) {
        this.language = language;
        return this;
    }
     ...
     */
    @Override
    public MyNotify setCreatedAt(final LocalDateTime createdAt) {
        this.createdAt = createdAt;
        return this;
    }
     ...
     */
    @Override
    public MyNotify setCreatedBy(final String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     */
    @Override
    public MyNotify setUpdatedAt(final LocalDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
     ...
     */
    @Override
    public MyNotify setUpdatedBy(final String updatedBy) {
        this.updatedBy = updatedBy;
        return this;
    }
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("MyNotify (");
