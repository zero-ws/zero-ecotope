...
public class TplModel implements VertxPojo, ITplModel {
    ...
    public TplModel(final ITplModel value) {
    ...
    public TplModel(
        ...
        final String code,
        final String type,
        final String tplCategory,
        final String tplIntegration,
        final String tplAcl,
        final String tplAclVisit,
        final String tplModel,
        final String tplEntity,
        final String tplApi,
        final String tplJob,
        final String tplUi,
        final String tplUiList,
        final String tplUiForm,
        final String sigma,
    ...
    public TplModel(final io.vertx.core.json.JsonObject json) {
        this();
        fromJson(json);
    }
     ...
     */
    @Override
    public TplModel setKey(final String key) {
        this.key = key;
        return this;
    }
     ...
     */
    @Override
    public TplModel setName(final String name) {
        this.name = name;
        return this;
    }
     ...
     */
    @Override
    public TplModel setCode(final String code) {
        this.code = code;
        return this;
    }
     ...
     */
    @Override
    public TplModel setType(final String type) {
        this.type = type;
        return this;
    }
     ...
     */
    @Override
    public TplModel setTplCategory(final String tplCategory) {
        this.tplCategory = tplCategory;
        return this;
    }
     ...
     */
    @Override
    public TplModel setTplIntegration(final String tplIntegration) {
        this.tplIntegration = tplIntegration;
        return this;
    }
     ...
     */
    @Override
    public TplModel setTplAcl(final String tplAcl) {
        this.tplAcl = tplAcl;
        return this;
    }
     ...
     */
    @Override
    public TplModel setTplAclVisit(final String tplAclVisit) {
        this.tplAclVisit = tplAclVisit;
        return this;
    }
     ...
     */
    @Override
    public TplModel setTplModel(final String tplModel) {
        this.tplModel = tplModel;
        return this;
    }
     ...
     */
    @Override
    public TplModel setTplEntity(final String tplEntity) {
        this.tplEntity = tplEntity;
        return this;
    }
     ...
     */
    @Override
    public TplModel setTplApi(final String tplApi) {
        this.tplApi = tplApi;
        return this;
    }
     ...
     */
    @Override
    public TplModel setTplJob(final String tplJob) {
        this.tplJob = tplJob;
        return this;
    }
     ...
     */
    @Override
    public TplModel setTplUi(final String tplUi) {
        this.tplUi = tplUi;
        return this;
    }
     ...
     */
    @Override
    public TplModel setTplUiList(final String tplUiList) {
        this.tplUiList = tplUiList;
        return this;
    }
     ...
     */
    @Override
    public TplModel setTplUiForm(final String tplUiForm) {
        this.tplUiForm = tplUiForm;
        return this;
    }
     ...
     */
    @Override
    public TplModel setSigma(final String sigma) {
        this.sigma = sigma;
        return this;
    }
     ...
     */
    @Override
    public TplModel setLanguage(final String language) {
        this.language = language;
        return this;
    }
     ...
     */
    @Override
    public TplModel setActive(final Boolean active) {
        this.active = active;
        return this;
    }
     ...
     */
    @Override
    public TplModel setMetadata(final String metadata) {
        this.metadata = metadata;
        return this;
    }
     ...
     */
    @Override
    public TplModel setCreatedAt(final LocalDateTime createdAt) {
        this.createdAt = createdAt;
        return this;
    }
     ...
     */
    @Override
    public TplModel setCreatedBy(final String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     */
    @Override
    public TplModel setUpdatedAt(final LocalDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
     ...
     */
    @Override
    public TplModel setUpdatedBy(final String updatedBy) {
        this.updatedBy = updatedBy;
        return this;
    }
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("TplModel (");
