...
public class MyTpl extends TableImpl<MyTplRecord> {
    ...
    /**
     * The column <code>ZDB.MY_TPL.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    public final TableField<MyTplRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 用户组绑定的统一标识");
    /**
     * The column <code>ZDB.MY_TPL.LANGUAGE</code>. 「language」- 使用的语言
     */
    public final TableField<MyTplRecord, String> LANGUAGE = createField(DSL.name("LANGUAGE"), SQLDataType.VARCHAR(10), this, "「language」- 使用的语言");
    /**
    ...
    /**
     * The column <code>ZDB.MY_TPL.METADATA</code>. 「metadata」- 附加配置数据
     */
    public final TableField<MyTplRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
    /**
