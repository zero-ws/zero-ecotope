...
public class MyMenu implements VertxPojo, IMyMenu {
    ...
    public MyMenu(final IMyMenu value) {
    ...
    public MyMenu(
        ...
        final String uri,
        final Long uiSort,
        final String uiParent,
        final String uiColorFg,
        final String uiColorBg,
        final String type,
        final String page,
    ...
    public MyMenu(final io.vertx.core.json.JsonObject json) {
        this();
        fromJson(json);
    }
     ...
     */
    @Override
    public MyMenu setKey(final String key) {
        this.key = key;
        return this;
    }
     ...
     */
    @Override
    public MyMenu setIcon(final String icon) {
        this.icon = icon;
        return this;
    }
     ...
     */
    @Override
    public MyMenu setText(final String text) {
        this.text = text;
        return this;
    }
     ...
     */
    @Override
    public MyMenu setUri(final String uri) {
        this.uri = uri;
        return this;
    }
     ...
     */
    @Override
    public MyMenu setUiSort(final Long uiSort) {
        this.uiSort = uiSort;
        return this;
    }
     ...
     */
    @Override
    public MyMenu setUiParent(final String uiParent) {
        this.uiParent = uiParent;
        return this;
    }
     ...
     */
    @Override
    public MyMenu setUiColorFg(final String uiColorFg) {
        this.uiColorFg = uiColorFg;
        return this;
    }
     ...
     */
    @Override
    public MyMenu setUiColorBg(final String uiColorBg) {
        this.uiColorBg = uiColorBg;
        return this;
    }
     ...
     */
    @Override
    public MyMenu setType(final String type) {
        this.type = type;
        return this;
    }
     ...
     */
    @Override
    public MyMenu setPage(final String page) {
        this.page = page;
        return this;
    }
     ...
     */
    @Override
    public MyMenu setPosition(final String position) {
        this.position = position;
        return this;
    }
     ...
     */
    @Override
    public MyMenu setOwner(final String owner) {
        this.owner = owner;
        return this;
    }
     ...
     */
    @Override
    public MyMenu setOwnerType(final String ownerType) {
        this.ownerType = ownerType;
        return this;
    }
     ...
     */
    @Override
    public MyMenu setActive(final Boolean active) {
        this.active = active;
        return this;
    }
     ...
     */
    @Override
    public MyMenu setSigma(final String sigma) {
        this.sigma = sigma;
        return this;
    }
     ...
     */
    @Override
    public MyMenu setMetadata(final String metadata) {
        this.metadata = metadata;
        return this;
    }
     ...
     */
    @Override
    public MyMenu setLanguage(final String language) {
        this.language = language;
        return this;
    }
     ...
     */
    @Override
    public MyMenu setCreatedAt(final LocalDateTime createdAt) {
        this.createdAt = createdAt;
        return this;
    }
     ...
     */
    @Override
    public MyMenu setCreatedBy(final String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     */
    @Override
    public MyMenu setUpdatedAt(final LocalDateTime updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
     ...
     */
    @Override
    public MyMenu setUpdatedBy(final String updatedBy) {
        this.updatedBy = updatedBy;
        return this;
    }
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("MyMenu (");
    ...
    @Override
    public void from(final IMyMenu from) {
        setKey(from.getKey());
    ...
    @Override
    public <E extends IMyMenu> E into(final E into) {
        into.from(this);
        return into;
    }
}
