...
public class MyNotify extends TableImpl<MyNotifyRecord> {
    ...
    /**
     * The column <code>ZDB.MY_NOTIFY.SIGMA</code>. 「sigma」- 用户组绑定的统一标识
     */
    public final TableField<MyNotifyRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(128), this, "「sigma」- 用户组绑定的统一标识");
    /**
     * The column <code>ZDB.MY_NOTIFY.LANGUAGE</code>. 「language」- 使用的语言
     */
    public final TableField<MyNotifyRecord, String> LANGUAGE = createField(DSL.name("LANGUAGE"), SQLDataType.VARCHAR(10), this, "「language」- 使用的语言");
    /**
    ...
    /**
     * The column <code>ZDB.MY_NOTIFY.METADATA</code>. 「metadata」- 附加配置数据
     */
    public final TableField<MyNotifyRecord, String> METADATA = createField(DSL.name("METADATA"), SQLDataType.CLOB(65535), this, "「metadata」- 附加配置数据");
    /**
