...
import io.zerows.extension.module.tpl.domain.tables.daos.MyMenuDao;
import io.zerows.extension.module.tpl.domain.tables.pojos.MyMenu;
import io.zerows.platform.constant.VString;
import io.zerows.program.Ux;

import java.util.List;

import static io.zerows.extension.module.tpl.common.Tl.LOG;
...
public class MenuService implements MenuStub {
    ...
    public Future<JsonArray> saveMy(final JsonObject condition, final JsonArray data) {
        ...
        final ADB jooq = DB.on(MyMenuDao.class);
