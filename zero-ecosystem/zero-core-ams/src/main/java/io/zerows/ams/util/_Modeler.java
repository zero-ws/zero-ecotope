...
import io.zerows.ams.annotations.HighOrder;
...
class _Modeler extends _It {
    ...
    public static String nsAtom(final String appName, final String identifier) {
        return _App.nsAtom(appName, identifier);
    }
