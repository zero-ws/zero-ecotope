...
import io.zerows.epoch.osgi.metadata.command.CommandFailureSize;
import io.zerows.epoch.osgi.metadata.command.CommandService;
import io.zerows.epoch.osgi.metadata.command.CommandServiceBID;
