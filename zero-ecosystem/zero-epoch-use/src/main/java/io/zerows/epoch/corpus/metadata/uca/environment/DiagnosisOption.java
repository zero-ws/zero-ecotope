package io.zerows.epoch.corpus.metadata.uca.environment;
 ...
 */
public class DiagnosisOption implements Serializable, HMacrocosm {
    // ------------- cache ----------------
    // 是否开启UI缓存，默认true，开启
    @JsonProperty(HMacrocosm.CACHE_UI)
    private Boolean cacheUi = Boolean.TRUE;

    // 是否打开授权缓存，默认true，开启
    @JsonProperty(HMacrocosm.CACHE_ADMIT)
    private Boolean cacheAdmit = Boolean.TRUE;
    // ------------- dev -------------------
    // 是否显示URI路由检测状况，默认 false，不检测
    @JsonProperty(HMacrocosm.DEV_WEB_URI)
    private Boolean devWebUri = Boolean.FALSE;
    @JsonProperty(HMacrocosm.DEV_JVM_STACK)
    private Boolean devJvmStack = Boolean.FALSE;
    @JsonProperty(HMacrocosm.DEV_JOB_BOOT)
    private Boolean devJobBoot = Boolean.FALSE;
    @JsonProperty(HMacrocosm.DEV_EXCEL_RANGE)
    private Boolean devExcelRange = Boolean.FALSE;
    @JsonProperty(HMacrocosm.DEV_JOOQ_COND)
    private Boolean devJooqCond = Boolean.FALSE;
    @JsonProperty(HMacrocosm.DEV_EXPR_BIND)
    private Boolean devExprBind = Boolean.FALSE;
    @JsonProperty(HMacrocosm.DEV_DAO_BIND)
    private Boolean devDaoBind = Boolean.TRUE;

    // 是否开启认证日志，默认false，关闭（5个地方调用）
    @JsonProperty(HMacrocosm.DEV_AUTHORIZED)
    private Boolean devAuthorized = Boolean.FALSE;

    // Z_CACHE_UI
    public Boolean getCacheUi() {
        return Ut.envWith(HMacrocosm.CACHE_UI, this.cacheUi, Boolean.class);
    }
    ...
    public Boolean getCacheAdmit() {
        return Ut.envWith(HMacrocosm.CACHE_ADMIT, this.cacheAdmit, Boolean.class);
    }
    ...
    public Boolean getDevAuthorized() {
        return Ut.envWith(HMacrocosm.DEV_AUTHORIZED, this.devAuthorized, Boolean.class);
    }
    ...
    public Boolean getDevWebUri() {
        return Ut.envWith(HMacrocosm.DEV_WEB_URI, this.devWebUri, Boolean.class);
    }
    ...
    public Boolean getDevJvmStack() {
        return Ut.envWith(HMacrocosm.DEV_JVM_STACK, this.devJvmStack, Boolean.class);
    }
    ...
    public Boolean getDevJobBoot() {
        return Ut.envWith(HMacrocosm.DEV_JOB_BOOT, this.devJobBoot, Boolean.class);
    }
    ...
    public Boolean getDevExcelRange() {
        return Ut.envWith(HMacrocosm.DEV_EXCEL_RANGE, this.devExcelRange, Boolean.class);
    }
    ...
    public Boolean getDevJooqCond() {
        return Ut.envWith(HMacrocosm.DEV_JOOQ_COND, this.devJooqCond, Boolean.class);
    }
    ...
    public Boolean getDevExprBind() {
        return Ut.envWith(HMacrocosm.DEV_EXPR_BIND, this.devExprBind, Boolean.class);
    }
    ...
    public Boolean getDevDaoBind() {
        return Ut.envWith(HMacrocosm.DEV_DAO_BIND, this.devDaoBind, Boolean.class);
    }
