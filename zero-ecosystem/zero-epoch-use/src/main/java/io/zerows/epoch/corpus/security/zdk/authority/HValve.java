package io.zerows.epoch.corpus.security.zdk.authority;
 ...
 */
public interface HValve extends HCommand.Async<JsonObject, JsonObject> {
    ...
    default Future<JsonObject> configure(final JsonObject input) {
        return Async.super.configure(input);
    }
}
